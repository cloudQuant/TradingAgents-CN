...
#
# 使用方法：
#   curl -fsSL https://raw.githubusercontent.com/your-org/云子量化/main/scripts/deploy_demo.sh | bash
#   或
#   bash deploy_demo.sh
################################################################################
...
GITHUB_REPO="https://github.com/your-org/云子量化"
GITHUB_RAW="https://raw.githubusercontent.com/your-org/云子量化/main"
...
show_info() {
    ...
    echo ""
    echo -e "${BLUE}文档:${NC}"
    echo -e "  完整文档: ${GREEN}https://github.com/your-org/云子量化/blob/main/docs/deploy_demo_system.md${NC}"
    echo ""
}
