...
class TestFuturesHqSubscribeExchangeSymbolCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试外盘-品种代码表数据集合
    
    接口类型：no_param
    AKShare接口：ak.futures_hq_subscribe_exchange_symbol()
    """
