...
class TestFuturesWarehouseReceiptCzceCollection:
    """Test futures_warehouse_receipt_czce collection API"""
    ...
    def test_collection_info_exists(self):
        ...
        for col in collections:
            if col["name"] == self.collection_name:
                found = True
                assert col["display_name"] == "仓单日报-郑州商品交易所"
                break
    ...
    def test_get_data(self, mock_get_db):
        ...
        items = [
            {"_id": "1", "date": "20200702", "symbol": "CF", "warehouse": "WH1", "receipt": 1000},
            {"_id": "2", "date": "20200702", "symbol": "CF", "warehouse": "WH2", "receipt": 2000}
        ]
    ...
    def test_update_data(self, mock_get_db):
        ...
        # ak.futures_warehouse_receipt_czce returns a dict of DataFrames
        mock_df = pd.DataFrame({
            "仓库": ["WH1", "WH2"],
            "仓单数量": [1000, 2000]
        })
        mock_ak.futures_warehouse_receipt_czce.return_value = {"CF": mock_df}
