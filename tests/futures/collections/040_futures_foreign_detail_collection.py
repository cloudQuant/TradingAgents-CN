...
class TestFuturesForeignDetailCollection:
    ...
    def test_collection_info_exists(self):
        ...
        found = any(col["name"] == self.collection_name and col["display_name"] == "外盘-合约详情" 
    ...
    def test_get_data(self, mock_get_db):
        ...
        items = [
            {"_id": "1", "交易品种": "黄金", "交易代码": "GC", "交易单位": "100盎司", "最小变动价位": "0.1美元/盎司", "上市交易所": "COMEX"},
            {"_id": "2", "交易品种": "原油", "交易代码": "CL", "交易单位": "1000桶", "最小变动价位": "0.01美元/桶", "上市交易所": "NYMEX"}
        ]
    ...
    def test_update_data(self, mock_get_db):
        ...
        mock_df = pd.DataFrame({
            ...
            "交易代码": ["GC", "CL"],
            "交易单位": ["100盎司", "1000桶"],
            "最小变动价位": ["0.1美元/盎司", "0.01美元/桶"],
            "上市交易所": ["COMEX", "NYMEX"]
        })
        mock_ak.futures_foreign_detail.return_value = mock_df
