...
class TestFuturesInventoryEmCollection:
    """Test futures_inventory_em collection API"""
    ...
    def test_collection_info_exists(self):
        ...
        for col in collections:
            if col["name"] == self.collection_name:
                found = True
                assert col["display_name"] == "库存数据-东方财富"
                break
    ...
    def test_get_data(self, mock_get_db):
        ...
        items = [
            {"_id": "1", "日期": "2023-01-01", "库存": 10000, "增减": 100.0, "symbol": "A"},
            {"_id": "2", "日期": "2023-01-02", "库存": 10100, "增减": 100.0, "symbol": "A"}
        ]
    ...
    def test_update_data(self, mock_get_db):
        ...
        mock_ak.futures_inventory_em.return_value = mock_df
