...
class TestFuturesGlobalSpotEmCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试外盘-实时行情数据-东财数据集合
    
    接口类型：no_param
    AKShare接口：ak.futures_global_spot_em()
    """
...
if __name__ == "__main__":
    ...
    test = TestFuturesGlobalSpotEmCollection()
