...
class TestFuturesContractInfoIneCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试上海国际能源交易中心-合约信息数据集合
    
    接口类型：date_param
    AKShare接口：ak.futures_contract_info_ine()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_contract_info_ine(date="20241213")
            if result is None:
