...
class TestFuturesHistEmCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试内盘-历史行情数据-东财数据集合
    
    接口类型：symbol_param
    AKShare接口：ak.futures_hist_em()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_hist_em(symbol="螺纹钢主力")
            if result is None:
    ...
    async def test_api_update_async(self):
        ...
        try:
            ...
            data = {
                "update_type": "single",
                "params": {'symbol': '螺纹钢主力', 'period': 'daily', 'start_date': '20241201', 'end_date': '20241213'}
            }
