...
class TestFuturesGlobalSpotEmCollection:
    ...
    def test_collection_info_exists(self):
        ...
        found = any(col["name"] == self.collection_name and col["display_name"] == "外盘-实时行情数据-东财" 
    ...
    def test_get_data(self, mock_get_db):
        ...
        items = [
            {"_id": "1", "序号": 1, "代码": "GC00Y", "名称": "COMEX黄金", "最新价": 1800.5, "涨跌幅": 0.5},
            {"_id": "2", "序号": 2, "代码": "CL00Y", "名称": "NYMEX原油", "最新价": 75.3, "涨跌幅": -0.3}
        ]
    ...
    def test_update_data(self, mock_get_db):
        ...
        mock_ak.futures_global_spot_em.return_value = mock_df
