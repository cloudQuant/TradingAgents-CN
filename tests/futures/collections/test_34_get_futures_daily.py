...
class TestGetFuturesDailyCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试内盘-历史行情数据-交易所数据集合
    
    接口类型：date_range_param
    AKShare接口：ak.get_futures_daily()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.get_futures_daily(start_date="20241201", end_date="20241205", market="SHFE")
            if result is None:
    ...
    async def test_api_update_async(self):
        ...
        try:
            ...
            data = {
                "update_type": "single",
                "params": {'start_date': '20241201', 'end_date': '20241213', 'market': 'SHFE'}
            }
