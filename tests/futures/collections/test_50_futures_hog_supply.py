...
class TestFuturesHogSupplyCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试生猪-供应维度数据集合
    
    接口类型：symbol_param
    AKShare接口：ak.futures_hog_supply()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_hog_supply(symbol="全国")
            if result is None:
