...
class TestFuturesToSpotCzceCollection:
    """Test futures_to_spot_czce collection API"""
    ...
    def test_collection_info_exists(self):
        ...
        for col in collections:
            if col["name"] == self.collection_name:
                found = True
                assert col["display_name"] == "期转现-郑商所"
                break
    ...
    def test_get_data(self, mock_get_db):
        ...
        items = [
            {"_id": "1", "date": "20210112", "合约代码": "SR105", "合约数量": 100},
            {"_id": "2", "date": "20210112", "合约代码": "SR105", "合约数量": 200}
        ]
    ...
    def test_update_data(self, mock_get_db):
        ...
        mock_ak.futures_to_spot_czce.return_value = mock_df
        ...
        # The update for this one needs query param 'date' (YYYYMMDD format)
