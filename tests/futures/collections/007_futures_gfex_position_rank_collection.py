...
class TestFuturesGfexPositionRankCollection:
    """Test futures_gfex_position_rank collection API"""
    ...
    def test_get_data(self, mock_get_db):
        ...
        items = [
            {"_id": "1", "date": "20231113", "symbol": "si2401", "rank": 1, "member_name": "Company A", "vol": 1000},
            {"_id": "2", "date": "20231113", "symbol": "si2401", "rank": 2, "member_name": "Company B", "vol": 900}
        ]
    ...
    def test_update_data(self, mock_get_db):
        ...
        # ak.futures_gfex_position_rank returns a dict of DataFrames
        ...
        mock_ak.futures_gfex_position_rank.return_value = {"si2401": mock_df}
        ...
        response = client.post(f"{self.base_url}/update?date=20231113")
        assert response.status_code == 200
        data = response.json()
        assert data["success"] is True
