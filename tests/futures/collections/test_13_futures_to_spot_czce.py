...
class TestFuturesToSpotCzceCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试期转现-郑商所数据集合
    
    接口类型：date_param
    AKShare接口：ak.futures_to_spot_czce()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_to_spot_czce(date="20241213")
            if result is None:
