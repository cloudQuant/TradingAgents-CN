...
class TestFuturesInventory99Collection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试库存数据-99期货网数据集合
    
    接口类型：symbol_param
    AKShare接口：ak.futures_inventory_99()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_inventory_99(symbol="豆一")
            if result is None:
