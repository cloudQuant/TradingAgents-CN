...
class TestFuturesToSpotShfeCollection:
    """Test futures_to_spot_shfe collection API"""
    ...
    def test_collection_info_exists(self):
        ...
        for col in collections:
            if col["name"] == self.collection_name:
                found = True
                assert col["display_name"] == "期转现-上期所"
                break
    ...
    def test_get_data(self, mock_get_db):
        ...
        items = [
            {"_id": "1", "date": "202312", "日期": "2023-12-01", "合约": "cu2401", "交割量": 100.0, "期转现量": 50.0},
            {"_id": "2", "date": "202312", "日期": "2023-12-02", "合约": "cu2401", "交割量": 200.0, "期转现量": 100.0}
        ]
    ...
    def test_update_data(self, mock_get_db):
        ...
        mock_ak.futures_to_spot_shfe.return_value = mock_df
