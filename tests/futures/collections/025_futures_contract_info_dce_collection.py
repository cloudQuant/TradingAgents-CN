...
class TestFuturesContractInfoDceCollection:
    """Test futures_contract_info_dce collection API"""
    ...
    def test_get_data(self, mock_get_db):
        ...
        items = [
            {"_id": "1", "品种": "豆粕", "合约代码": "m2401", "交易单位": 10, "最小变动价位": 1.0, "开始交易日": "20231015", "最后交易日": "20240115", "最后交割日": "20240119"},
            {"_id": "2", "品种": "豆粕", "合约代码": "m2402", "交易单位": 10, "最小变动价位": 1.0, "开始交易日": "20231115", "最后交易日": "20240215", "最后交割日": "20240219"}
        ]
    ...
    def test_update_data(self, mock_get_db):
        ...
        mock_ak.futures_contract_info_dce.return_value = mock_df
