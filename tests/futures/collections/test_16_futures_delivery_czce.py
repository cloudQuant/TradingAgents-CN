...
class TestFuturesDeliveryCzceCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试交割统计-郑商所数据集合
    
    接口类型：date_param
    AKShare接口：ak.futures_delivery_czce()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_delivery_czce(date="202411")
            if result is None:
