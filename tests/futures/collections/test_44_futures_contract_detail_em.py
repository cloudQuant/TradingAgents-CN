...
class TestFuturesContractDetailEmCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试期货合约详情-东财数据集合
    
    接口类型：symbol_param
    AKShare接口：ak.futures_contract_detail_em()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_contract_detail_em(symbol="聚氯乙烯2501")
            if result is None:
