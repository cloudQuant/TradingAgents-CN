...
class TestFuturesDeliveryDceCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试交割统计-大商所数据集合
    
    接口类型：date_param
    AKShare接口：ak.futures_delivery_dce()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_delivery_dce(date="202411")
            if result is None:
