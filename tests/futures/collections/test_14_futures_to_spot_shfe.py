...
class TestFuturesToSpotShfeCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试期转现-上期所数据集合
    
    接口类型：date_param
    AKShare接口：ak.futures_to_spot_shfe()
    """
    ...
    # 接口配置
    api_type = "date_param"
    akshare_func = "futures_to_spot_shfe"
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_to_spot_shfe(date="202411")
            if result is None:
