...
class TestFuturesContractInfoGfexCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试广州期货交易所-合约信息数据集合
    
    接口类型：no_param
    AKShare接口：ak.futures_contract_info_gfex()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_contract_info_gfex()
            if result is None:
