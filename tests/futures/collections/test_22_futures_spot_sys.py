...
class TestFuturesSpotSysCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试现期图数据集合
    
    接口类型：symbol_param
    AKShare接口：ak.futures_spot_sys()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_spot_sys(symbol="铜")
            if result is None:
...
if __name__ == "__main__":
    ...
    test = TestFuturesSpotSysCollection()
