...
class TestFuturesGfexPositionRankCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试广州期货交易所-持仓排名数据集合
    
    接口类型：date_param
    AKShare接口：ak.futures_gfex_position_rank()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_gfex_position_rank(date="20241213")
            if result is None:
...
if __name__ == "__main__":
    ...
    test = TestFuturesGfexPositionRankCollection()
