...
class TestFuturesToSpotDceCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试期转现-大商所数据集合
    
    接口类型：date_param
    AKShare接口：ak.futures_to_spot_dce()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_to_spot_dce(date="202411")
            if result is None:
