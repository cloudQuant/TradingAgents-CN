...
class TestFuturesContractInfoCffexCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试中国金融期货交易所-合约信息数据集合
    
    接口类型：date_param
    AKShare接口：ak.futures_contract_info_cffex()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_contract_info_cffex(date="20241213")
            if result is None:
