...
class TestFuturesDeliveryMatchCzceCollection:
    """Test futures_delivery_match_czce collection API"""

    def setup_method(self):
        self.collection_name = "futures_delivery_match_czce"
    ...
    def test_collection_info_exists(self):
        ...
        for col in collections:
            if col["name"] == self.collection_name:
                found = True
                assert col["display_name"] == "交割配对-郑商所"
                break
    ...
    def test_get_data(self, mock_get_db):
        ...
        items = [
            {"_id": "1", "date": "20210106", "卖方会员": "001", "卖方会员-会员简称": "会员A", "买方会员": "002", "买方会员-会员简称": "会员B", "交割量": 100.0},
            {"_id": "2", "date": "20210106", "卖方会员": "003", "卖方会员-会员简称": "会员C", "买方会员": "004", "买方会员-会员简称": "会员D", "交割量": 200.0}
        ]
    ...
    def test_update_data(self, mock_get_db):
        ...
        mock_ak.futures_delivery_match_czce.return_value = mock_df
        ...
        response = client.post(f"{self.base_url}/update?date=20210106")
        assert response.status_code == 200
        data = response.json()
        assert data["success"] is True
