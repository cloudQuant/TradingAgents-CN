...
class TestFuturesContractDetailCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试期货合约详情-新浪数据集合
    
    接口类型：symbol_param
    AKShare接口：ak.futures_contract_detail()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_contract_detail(symbol="V2501")
            if result is None:
