...
class TestFuturesWarehouseReceiptCzceCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试仓单日报-郑州商品交易所数据集合
    
    接口类型：date_param
    AKShare接口：ak.futures_warehouse_receipt_czce()
    """
    ...
    # 接口配置
    api_type = "date_param"
    akshare_func = "futures_warehouse_receipt_czce"
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_warehouse_receipt_czce(date="20241213")
            if result is None:
