...
class TestFuturesIndexCcidxCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试中证商品指数数据集合
    
    接口类型：symbol_param
    AKShare接口：ak.futures_index_ccidx()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_index_ccidx(symbol="中证商品期货指数")
            if result is None:
