...
class TestFuturesDeliveryMatchDceCollection(FuturesCollectionTestBase, PlaywrightAPITestMixin):
    """测试交割配对-大商所数据集合
    
    接口类型：date_param
    AKShare接口：ak.futures_delivery_match_dce()
    """
    ...
    def test_akshare_interface(self):
        ...
        try:
            ...
            result = ak.futures_delivery_match_dce(date="202411")
            if result is None:
...
if __name__ == "__main__":
    ...
    test = TestFuturesDeliveryMatchDceCollection()
