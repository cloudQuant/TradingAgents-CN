...
1. 数据集合：创建一个新的数据集合，名称为**港股财务报表**(<http://localhost:3000/stocks/collections/stock_financial_hk_report_em)>
...
2. 测试用例文件：`tests/stocks/collections/181_stock_financial_hk_report_em_collection.py`
3. 开发实现相应的前端和后端功能
4. 运行测试，修复测试失败的问题
