...
测试目标：
1. 验证 stock_hot_rank_em 数据集合的完整功能
...
class TestStockHotRankEmCollection:
    """人气榜-A股 集合测试类"""
    ...
    def test_ui_update_data_flow(self):
        ...
        collection_url = f"{frontend_url}/stocks/collections/stock_hot_rank_em"
