...
测试目标：
1. 验证 stock_sz_a_spot_em 数据集合的完整功能
...
class TestStockSzASpotEMCollection:
    """深 A 股-实时行情数据 集合测试类"""
    ...
    def test_ui_update_data_flow(self):
        ...
        collection_url = f"{frontend_url}/stocks/collections/stock_sz_a_spot_em"
