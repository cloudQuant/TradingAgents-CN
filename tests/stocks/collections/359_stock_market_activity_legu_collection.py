...
测试目标：
1. 验证 stock_market_activity_legu 数据集合的完整功能
...
class TestStockMarketActivityLeguCollection:
    """赚钱效应分析 集合测试类"""
    ...
    def test_ui_update_data_flow(self):
        ...
        collection_url = f"{frontend_url}/stocks/collections/stock_market_activity_legu"
