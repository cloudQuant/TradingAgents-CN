...
测试目标：
1. 验证 stock_bid_ask_em 数据集合的完整功能
...
class TestStockBidAskEMCollection:
    """东方财富-行情报价 集合测试类"""
    ...
    def test_collection_data_fields(self, api_base_url, auth_headers, collection_name):
        ...
        if payload["items"]:
            ...
            assert any(key in item for key in ["item", "value", "price"]), "应该包含行情相关字段"
    ...
    def test_ui_update_data_flow(self):
        ...
        collection_url = f"{frontend_url}/stocks/collections/stock_bid_ask_em"
