...
测试目标：
1. 验证 stock_individual_info_em 数据集合的完整功能
...
class TestStockIndividualInfoEMCollection:
    """东方财富-个股信息 集合测试类"""
    ...
    def test_ui_update_data_flow(self):
        ...
        collection_url = f"{frontend_url}/stocks/collections/stock_individual_info_em"
