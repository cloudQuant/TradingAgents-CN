<template>
  <div class="stock_sgt_settlement_exchange_rate_szse-container">
...
const API_BASE = '/api/stocks/collections/stock_sgt_settlement_exchange_rate_szse'
...
<style scoped>
.stock_sgt_settlement_exchange_rate_szse-container {
  padding: 20px;
}
