<template>
  <div class="stock_gpzy_distribute_statistics_bank_em-container">
...
const API_BASE = '/api/stocks/collections/stock_gpzy_distribute_statistics_bank_em'
...
<style scoped>
.stock_gpzy_distribute_statistics_bank_em-container {
  padding: 20px;
}
