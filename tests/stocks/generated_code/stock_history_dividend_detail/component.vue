<template>
  <div class="stock_history_dividend_detail-container">
...
const API_BASE = '/api/stocks/collections/stock_history_dividend_detail'
...
<style scoped>
.stock_history_dividend_detail-container {
  padding: 20px;
}
