<template>
  <div class="stock_industry_category_cninfo-container">
...
const API_BASE = '/api/stocks/collections/stock_industry_category_cninfo'
...
<style scoped>
.stock_industry_category_cninfo-container {
  padding: 20px;
}
