<template>
  <div class="news_trade_notify_dividend_baidu-container">
...
const API_BASE = '/api/stocks/collections/news_trade_notify_dividend_baidu'
...
<style scoped>
.news_trade_notify_dividend_baidu-container {
  padding: 20px;
}
