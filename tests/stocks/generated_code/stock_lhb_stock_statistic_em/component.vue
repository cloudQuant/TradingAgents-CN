<template>
  <div class="stock_lhb_stock_statistic_em-container">
...
const API_BASE = '/api/stocks/collections/stock_lhb_stock_statistic_em'
...
<style scoped>
.stock_lhb_stock_statistic_em-container {
  padding: 20px;
}
