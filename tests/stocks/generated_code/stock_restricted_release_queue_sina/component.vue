<template>
  <div class="stock_restricted_release_queue_sina-container">
...
const API_BASE = '/api/stocks/collections/stock_restricted_release_queue_sina'
...
<style scoped>
.stock_restricted_release_queue_sina-container {
  padding: 20px;
}
