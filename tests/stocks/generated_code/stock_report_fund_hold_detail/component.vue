<template>
  <div class="stock_report_fund_hold_detail-container">
...
const API_BASE = '/api/stocks/collections/stock_report_fund_hold_detail'
...
<style scoped>
.stock_report_fund_hold_detail-container {
  padding: 20px;
}
