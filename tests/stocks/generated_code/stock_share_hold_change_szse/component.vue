<template>
  <div class="stock_share_hold_change_szse-container">
    <el-card class="header-card">
      <h2>董监高及相关人员持股变动-深证</h2>
    </el-card>
...
const API_BASE = '/api/stocks/collections/stock_share_hold_change_szse'
...
<style scoped>
.stock_share_hold_change_szse-container {
  padding: 20px;
}
