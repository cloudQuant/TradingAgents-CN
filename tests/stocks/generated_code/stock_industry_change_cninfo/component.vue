<template>
  <div class="stock_industry_change_cninfo-container">
    <el-card class="header-card">
      <h2>上市公司行业归属的变动情况-巨潮资讯</h2>
    </el-card>
...
const API_BASE = '/api/stocks/collections/stock_industry_change_cninfo'
...
<style scoped>
.stock_industry_change_cninfo-container {
  padding: 20px;
}
