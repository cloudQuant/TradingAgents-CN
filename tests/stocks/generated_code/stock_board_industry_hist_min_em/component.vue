<template>
  <div class="stock_board_industry_hist_min_em-container">
...
const API_BASE = '/api/stocks/collections/stock_board_industry_hist_min_em'
...
<style scoped>
.stock_board_industry_hist_min_em-container {
  padding: 20px;
}
