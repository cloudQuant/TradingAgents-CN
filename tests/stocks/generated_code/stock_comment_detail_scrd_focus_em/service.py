...
class StockCommentDetailScrdFocusEmService:
    """用户关注指数服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_comment_detail_scrd_focus_em
        self.provider = StockCommentDetailScrdFocusEmProvider()
