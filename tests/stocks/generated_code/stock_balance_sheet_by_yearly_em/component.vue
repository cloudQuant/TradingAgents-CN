<template>
  <div class="stock_balance_sheet_by_yearly_em-container">
...
const API_BASE = '/api/stocks/collections/stock_balance_sheet_by_yearly_em'
...
<style scoped>
.stock_balance_sheet_by_yearly_em-container {
  padding: 20px;
}
