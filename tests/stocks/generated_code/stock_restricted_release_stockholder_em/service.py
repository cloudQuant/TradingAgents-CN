...
class StockRestrictedReleaseStockholderEmService:
    """解禁股东服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_restricted_release_stockholder_em
        self.provider = StockRestrictedReleaseStockholderEmProvider()
