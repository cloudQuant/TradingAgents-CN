<template>
  <div class="stock_share_hold_change_bse-container">
    <el-card class="header-card">
      <h2>董监高及相关人员持股变动-北证</h2>
    </el-card>
...
const API_BASE = '/api/stocks/collections/stock_share_hold_change_bse'
...
<style scoped>
.stock_share_hold_change_bse-container {
  padding: 20px;
}
