<template>
  <div class="stock_hk_hot_rank_detail_realtime_em-container">
...
const API_BASE = '/api/stocks/collections/stock_hk_hot_rank_detail_realtime_em'
...
<style scoped>
.stock_hk_hot_rank_detail_realtime_em-container {
  padding: 20px;
}
