<template>
  <div class="stock_zh_a_disclosure_relation_cninfo-container">
...
const API_BASE = '/api/stocks/collections/stock_zh_a_disclosure_relation_cninfo'
...
<style scoped>
.stock_zh_a_disclosure_relation_cninfo-container {
  padding: 20px;
}
