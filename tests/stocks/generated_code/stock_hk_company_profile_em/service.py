...
from .providers.stock_hk_company_profile_em_provider import StockHkCompanyProfileEmProvider

logger = logging.getLogger(__name__)


class StockHkCompanyProfileEmService:
    """公司资料服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hk_company_profile_em
        self.provider = StockHkCompanyProfileEmProvider()
