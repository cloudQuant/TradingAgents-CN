<template>
  <div class="stock_hk_valuation_comparison_em-container">
...
const API_BASE = '/api/stocks/collections/stock_hk_valuation_comparison_em'
...
<style scoped>
.stock_hk_valuation_comparison_em-container {
  padding: 20px;
}
