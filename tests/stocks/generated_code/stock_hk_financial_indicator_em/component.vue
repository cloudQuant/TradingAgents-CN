<template>
  <div class="stock_hk_financial_indicator_em-container">
...
const API_BASE = '/api/stocks/collections/stock_hk_financial_indicator_em'
...
<style scoped>
.stock_hk_financial_indicator_em-container {
  padding: 20px;
}
