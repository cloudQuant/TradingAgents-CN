<template>
  <div class="stock_lh_yyb_control-container">
    <el-card class="header-card">
      <h2>龙虎榜-营业部排行-抱团操作实力</h2>
    </el-card>
...
const API_BASE = '/api/stocks/collections/stock_lh_yyb_control'
...
<style scoped>
.stock_lh_yyb_control-container {
  padding: 20px;
}
