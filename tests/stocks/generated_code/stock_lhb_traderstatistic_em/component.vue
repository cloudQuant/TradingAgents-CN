<template>
  <div class="stock_lhb_traderstatistic_em-container">
...
const API_BASE = '/api/stocks/collections/stock_lhb_traderstatistic_em'
...
<style scoped>
.stock_lhb_traderstatistic_em-container {
  padding: 20px;
}
