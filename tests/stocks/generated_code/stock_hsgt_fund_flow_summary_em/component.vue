<template>
  <div class="stock_hsgt_fund_flow_summary_em-container">
...
const API_BASE = '/api/stocks/collections/stock_hsgt_fund_flow_summary_em'
...
<style scoped>
.stock_hsgt_fund_flow_summary_em-container {
  padding: 20px;
}
