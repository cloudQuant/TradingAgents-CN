<template>
  <div class="stock_institute_recommend_detail-container">
...
const API_BASE = '/api/stocks/collections/stock_institute_recommend_detail'
...
<style scoped>
.stock_institute_recommend_detail-container {
  padding: 20px;
}
