<template>
  <div class="stock_hold_management_person_em-container">
...
const API_BASE = '/api/stocks/collections/stock_hold_management_person_em'
...
<style scoped>
.stock_hold_management_person_em-container {
  padding: 20px;
}
