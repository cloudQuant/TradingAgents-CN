"""
债券现券市场概览-上交所数据集合测试用例
需求文档: tests/bonds/requirements/08_债券现券市场概览-上交所.md
数据唯一标识: 债券现货和日期
"""
from test_base import BondCollectionTestBase


class TestBondCashSummarySseCollection(BondCollectionTestBase):
    """测试债券现券市场概览-上交所数据集合"""
...
if __name__ == "__main__":
    test = TestBondCashSummarySseCollection()
