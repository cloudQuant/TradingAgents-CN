"""
地方债发行数据集合测试用例
需求文档: tests/bonds/requirements/29_地方债发行.md
数据唯一标识: 债券代码
"""
from test_base import BondCollectionTestBase


class TestBondLocalGovernmentIssueCninfoCollection(BondCollectionTestBase):
    """测试地方债发行数据集合"""
...
if __name__ == "__main__":
    test = TestBondLocalGovernmentIssueCninfoCollection()
