...
3. 更新数据的时候，默认更新所有的债券数据
4. 字段显示参考数据实例

### 测试驱动开发

1. 先写测试代码，测试代码放在 tests/collections 目录下, 页面样式和功能和之前的数据集合保持一致。测试用例需要包含1. 页面存在，2. 页面包含相应的功能，3. 页面的按钮点击事件可以正常工作，涉及到刷新，更新数据，清空数据等。4. 更新数据中参数和接口中保持一致
2. 然后实现代码
3. 最后测试代码