"""
企业债发行数据集合测试用例
需求文档: tests/bonds/requirements/30_企业债发行.md
数据唯一标识: 债券代码
"""
from test_base import BondCollectionTestBase


class TestBondCorporateIssueCninfoCollection(BondCollectionTestBase):
    """测试企业债发行数据集合"""
...
if __name__ == "__main__":
    test = TestBondCorporateIssueCninfoCollection()
