"""
中债综合指数数据集合测试用例
需求文档: tests/bonds/requirements/34_中债综合指数.md
数据唯一标识: 指标类型、期限和日期
"""
from test_base import BondCollectionTestBase


class TestBondCompositeIndexCbondCollection(BondCollectionTestBase):
    """测试中债综合指数数据集合"""
...
if __name__ == "__main__":
    test = TestBondCompositeIndexCbondCollection()
