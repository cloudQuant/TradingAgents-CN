"""
新浪财经中金所沪深300指数指定合约实时行情 数据集合测试

测试目标：
1. 验证 option_cffex_hs300_spot_sina 数据集合的完整功能
2. 测试数据获取、存储、更新、展示等核心功能
3. 确保数据的正确性和完整性

接口信息：
- 接口名称：option_cffex_hs300_spot_sina
- 描述：新浪财经-中金所-沪深300指数-指定合约-实时行情
- 输入参数：symbol (str) - 合约代码，如 "io2104"
...
class TestOptionCffexHs300SpotSinaCollection:
    """新浪财经中金所沪深300指数指定合约实时行情 集合测试类"""
