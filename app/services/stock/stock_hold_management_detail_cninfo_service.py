...
class StockHoldManagementDetailCninfoService:
    """高管持股变动明细服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hold_management_detail_cninfo
        self.provider = StockHoldManagementDetailCninfoProvider()
