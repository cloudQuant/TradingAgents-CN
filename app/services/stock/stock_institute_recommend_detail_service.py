...
class StockInstituteRecommendDetailService:
    """股票评级记录服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_institute_recommend_detail
        self.provider = StockInstituteRecommendDetailProvider()
