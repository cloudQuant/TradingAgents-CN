...
class StockCommentDetailZlkpJgcydEmService:
    """机构参与度服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_comment_detail_zlkp_jgcyd_em
        self.provider = StockCommentDetailZlkpJgcydEmProvider()
