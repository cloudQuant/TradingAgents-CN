...
class StockGpzyDistributeStatisticsBankEmService:
    """质押机构分布统计-银行服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gpzy_distribute_statistics_bank_em
        self.provider = StockGpzyDistributeStatisticsBankEmProvider()
