...
class StockSgtSettlementExchangeRateSzseService:
    """结算汇率-深港通服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_sgt_settlement_exchange_rate_szse
        self.provider = StockSgtSettlementExchangeRateSzseProvider()
