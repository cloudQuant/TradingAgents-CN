...
class StockRestrictedReleaseQueueSinaService:
    """个股限售解禁-新浪服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_restricted_release_queue_sina
        self.provider = StockRestrictedReleaseQueueSinaProvider()
