    ...
    async def get_collection_info(self, collection_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "last_updated": latest.get("更新时间") if latest and "更新时间" in latest else None,
                "oldest_date": oldest.get("更新时间") if oldest and "更新时间" in oldest else None,
