...
class StockGpzyDistributeStatisticsCompanyEmService:
    """质押机构分布统计-证券公司服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gpzy_distribute_statistics_company_em
        self.provider = StockGpzyDistributeStatisticsCompanyEmProvider()
