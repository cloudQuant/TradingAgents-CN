...
class StockRestrictedReleaseSummaryEmService:
    """限售股解禁服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_restricted_release_summary_em
        self.provider = StockRestrictedReleaseSummaryEmProvider()
