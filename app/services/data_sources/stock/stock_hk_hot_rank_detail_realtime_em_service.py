...
class StockHkHotRankDetailRealtimeEmService:
    """港股服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hk_hot_rank_detail_realtime_em
        self.provider = StockHkHotRankDetailRealtimeEmProvider()
