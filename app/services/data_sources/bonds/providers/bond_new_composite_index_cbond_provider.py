...
class BondNewCompositeIndexCbondProvider:
    """中债新综合指数数据提供者"""
    
    def __init__(self):
        self.collection_name = "bond_new_composite_index_cbond"
        self.display_name = "中债新综合指数"
    ...
    def fetch_data(self, **kwargs) -> pd.DataFrame:
        ...
        try:
            ...
            df = ak.bond_new_composite_index_cbond(indicator=indicator, period=period)
            ...
            df['期限'] = period
            df['数据源'] = 'akshare'
            df['接口名称'] = 'bond_new_composite_index_cbond'
