...
class BondLocalGovernmentIssueCninfoProvider:
    """地方债发行数据提供者"""
    
    def __init__(self):
        self.collection_name = "bond_local_government_issue_cninfo"
        self.display_name = "地方债发行"
    ...
    def fetch_data(self, **kwargs) -> pd.DataFrame:
        ...
        try:
            ...
            df['数据源'] = 'akshare'
            df['接口名称'] = 'bond_local_government_issue_cninfo'
