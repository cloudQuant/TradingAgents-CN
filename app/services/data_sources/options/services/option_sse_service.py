"""
上交所期权数据服务
包含: option_current_day_sse, option_risk_indicator_sse, option_daily_stats_sse
"""
...
class OptionCurrentDaySseService(BaseOptionService):
    """上交所当日合约服务"""
    ...
    async def update_batch_data(self, task_id: str = None, **kwargs) -> Dict[str, Any]:
        try:
            if self.task_manager and task_id:
                await self.task_manager.update_task(task_id, progress=10, message="正在获取上交所当日合约...")
            ...
            logger.error(f"更新上交所当日合约失败: {e}")
            return {"success": False, "message": str(e)}


class OptionRiskIndicatorSseService(BaseOptionService):
    """上交所期权风险指标服务"""
    ...
    async def update_batch_data(self, task_id: str = None, days: int = 5, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"批量更新期权风险指标失败: {e}")
            return {"success": False, "message": str(e)}


class OptionDailyStatsSseService(BaseOptionService):
    """上交所期权每日统计服务"""
    ...
    async def update_batch_data(self, task_id: str = None, days: int = 5, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"批量更新上交所期权统计失败: {e}")
            return {"success": False, "message": str(e)}
