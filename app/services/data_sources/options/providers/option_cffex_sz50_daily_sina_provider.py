...
class OptionCffexSz50DailySinaProvider(BaseProvider):
    """中金所上证50指数日频行情数据提供者"""
    
    collection_name = "option_cffex_sz50_daily_sina"
    display_name = "中金所上证50指数日频行情"
    akshare_func = "option_cffex_sz50_daily_sina"
    unique_keys = ["symbol", "日期"]
    
    collection_description = "中金所上证50指数指定合约日频行情"
    collection_route = "/options/collections/option_cffex_sz50_daily_sina"
    collection_order = 14
