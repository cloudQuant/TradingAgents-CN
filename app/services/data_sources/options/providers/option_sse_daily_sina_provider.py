...
class OptionSseDailySinaProvider(BaseProvider):
    """期权日数据提供者"""
    
    collection_name = "option_sse_daily_sina"
    display_name = "期权日数据"
    akshare_func = "option_sse_daily_sina"
    unique_keys = ["合约代码", "日期"]
    
    collection_description = "期权行情日数据"
    collection_route = "/options/collections/option_sse_daily_sina"
    collection_order = 24
