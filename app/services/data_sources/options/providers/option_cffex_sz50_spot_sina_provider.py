...
class OptionCffexSz50SpotSinaProvider(BaseProvider):
    """中金所上证50指数实时行情数据提供者"""
    
    collection_name = "option_cffex_sz50_spot_sina"
    display_name = "中金所上证50指数实时行情"
    akshare_func = "option_cffex_sz50_spot_sina"
    unique_keys = ["symbol", "时间"]
    
    collection_description = "新浪财经-中金所上证50指数指定合约实时行情"
    collection_route = "/options/collections/option_cffex_sz50_spot_sina"
    collection_order = 11
