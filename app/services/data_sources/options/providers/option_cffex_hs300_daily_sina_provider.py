...
class OptionCffexHs300DailySinaProvider(BaseProvider):
    """中金所沪深300指数日频行情数据提供者"""
    
    collection_name = "option_cffex_hs300_daily_sina"
    display_name = "中金所沪深300指数日频行情"
    akshare_func = "option_cffex_hs300_daily_sina"
    unique_keys = ["symbol", "日期"]
    
    collection_description = "中金所沪深300指数指定合约日频行情"
    collection_route = "/options/collections/option_cffex_hs300_daily_sina"
    collection_order = 15
