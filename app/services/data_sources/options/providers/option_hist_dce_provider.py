...
class OptionHistDceProvider(BaseProvider):
    """大商所期权数据提供者"""
    
    collection_name = "option_hist_dce"
    display_name = "大商所期权数据"
    akshare_func = "option_hist_dce"
    unique_keys = ["品种", "日期", "合约代码"]
    
    collection_description = "大连商品交易所商品期权数据"
    collection_route = "/options/collections/option_hist_dce"
    collection_order = 38
