"""中金所中证1000指数实时行情数据提供者"""
from app.services.data_sources.base_provider import BaseProvider


class OptionCffexZz1000SpotSinaProvider(BaseProvider):
    """中金所中证1000指数实时行情数据提供者"""
    
    collection_name = "option_cffex_zz1000_spot_sina"
    display_name = "中金所中证1000指数实时行情"
    akshare_func = "option_cffex_zz1000_spot_sina"
    unique_keys = ["symbol", "时间"]
    
    collection_description = "新浪财经-中金所中证1000指数指定合约实时行情"
    collection_route = "/options/collections/option_cffex_zz1000_spot_sina"
    collection_order = 13
