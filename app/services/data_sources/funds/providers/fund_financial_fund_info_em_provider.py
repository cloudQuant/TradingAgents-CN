...
class FundFinancialFundInfoEmProvider:
    """理财型基金历史行情-东财数据提供者"""
    
    def __init__(self):
        self.collection_name = "fund_financial_fund_info_em"
        self.display_name = "理财型基金历史行情-东财"
    ...
    def fetch_data(self, **kwargs) -> pd.DataFrame:
        ...
        try:
            ...
            df = ak.fund_financial_fund_info_em(fund=str(fund))
