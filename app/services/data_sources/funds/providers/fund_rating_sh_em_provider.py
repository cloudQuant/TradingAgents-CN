"""
基金评级-上海证券-东财数据提供者（重构版：继承SimpleProvider）
"""
from app.services.data_sources.base_provider import SimpleProvider


class FundRatingShEmProvider(SimpleProvider):
    """基金评级-上海证券-东财数据提供者"""
    ...
    field_info = [
        ...
        {"name": "5年期评级-5年评级", "type": "float", "description": ""},
        {"name": "5年期评级-较上期", "type": "float", "description": ""},
