"""
基金分红公告-东财数据提供者（重构版：继承BaseProvider，需要symbol参数）
"""
from app.services.data_sources.base_provider import BaseProvider


class FundAnnouncementDividendEmProvider(BaseProvider):
    """基金分红公告-东财数据提供者（需要基金代码参数）"""

    collection_description = "东方财富网站-天天基金网-基金档案-基金公告-分红配送（需要基金代码，支持单个/批量更新）"
    collection_route = "/funds/collections/fund_announcement_dividend_em"
    collection_order = 69
    ...
    field_info = [
        ...
        {"name": "来源", "type": "string", "description": "来源接口: fund_announcement_dividend_em"},
    ]
