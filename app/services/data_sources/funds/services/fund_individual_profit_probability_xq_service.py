...
class FundIndividualProfitProbabilityXqService:
    """基金盈利概率-雪球服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.funds.fund_individual_profit_probability_xq
        self.provider = FundIndividualProfitProbabilityXqProvider()
