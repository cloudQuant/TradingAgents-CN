...
class FundOpenFundInfoEmService(BaseService):
    """开放式基金历史行情-东财服务"""
    
    # ===== 必须定义的属性 =====
    collection_name = "fund_open_fund_info_em"
    provider_class = FundOpenFundInfoEmProvider
    
    # ===== 可选配置 =====
    time_field = "scraped_at"
    
    # 批量更新配置：从fund_open_fund_daily_em获取基金代码列表
    batch_source_collection = "fund_open_fund_daily_em"
