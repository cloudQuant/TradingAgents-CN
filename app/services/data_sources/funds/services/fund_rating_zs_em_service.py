"""
基金评级-招商证券-东财服务（重构版：继承BaseService，需要季度日期参数）
"""
...
from app.services.data_sources.funds.providers.fund_rating_zs_em_provider import FundRatingZsEmProvider

logger = logging.getLogger(__name__)


class FundRatingZsEmService(BaseService):
    """基金评级-招商证券-东财服务（需要季度日期参数）"""
