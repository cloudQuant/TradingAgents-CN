...
class FundReportIndustryAllocationCninfoService:
    """基金报告行业配置-巨潮服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.funds.fund_report_industry_allocation_cninfo
        self.provider = FundReportIndustryAllocationCninfoProvider()
