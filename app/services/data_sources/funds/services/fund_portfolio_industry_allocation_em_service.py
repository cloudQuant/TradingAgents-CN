...
from app.services.data_sources.funds.providers.fund_portfolio_industry_allocation_em_provider import FundPortfolioIndustryAllocationEmProvider
from app.services.database.control_mongodb import ControlMongodb

logger = logging.getLogger(__name__)


class FundPortfolioIndustryAllocationEmService(BaseService):
    """基金行业配置-东财服务"""
