...
class FundPortfolioIndustryAllocationEmService:
    """基金行业配置-东财服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.funds.fund_portfolio_industry_allocation_em
        self.provider = FundPortfolioIndustryAllocationEmProvider()
