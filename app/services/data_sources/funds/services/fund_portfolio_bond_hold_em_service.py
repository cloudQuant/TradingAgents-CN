...
from app.services.data_sources.funds.providers.fund_portfolio_bond_hold_em_provider import FundPortfolioBondHoldEmProvider
from app.services.database.control_mongodb import ControlMongodb

logger = logging.getLogger(__name__)


class FundPortfolioBondHoldEmService(BaseService):
    """基金持仓债券-东财服务"""
    
    # ===== 必须定义的属性 =====
    collection_name = "fund_portfolio_bond_hold_em"
    provider_class = FundPortfolioBondHoldEmProvider
