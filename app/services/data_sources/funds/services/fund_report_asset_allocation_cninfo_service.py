...
class FundReportAssetAllocationCninfoService:
    """基金报告资产配置-巨潮服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.funds.fund_report_asset_allocation_cninfo
        self.provider = FundReportAssetAllocationCninfoProvider()
