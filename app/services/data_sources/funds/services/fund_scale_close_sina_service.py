"""
封闭式基金规模-新浪服务（重构版：继承SimpleService，无参数接口，不需要批量更新）
"""
...
from app.services.data_sources.funds.providers.fund_scale_close_sina_provider import FundScaleCloseSinaProvider
    ...
    async def update_single_data(self, **kwargs) -> Dict[str, Any]:
        ...
        async with self._update_lock:
            try:
                ...
                # 不传递任何参数给 provider（fund_scale_close_sina 接口不需要参数）
