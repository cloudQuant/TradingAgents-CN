"""
基金评级-济安金信-东财服务（重构版：继承BaseService，需要季度日期参数）
"""
...
from app.services.data_sources.funds.providers.fund_rating_ja_em_provider import FundRatingJaEmProvider

logger = logging.getLogger(__name__)


class FundRatingJaEmService(BaseService):
    """基金评级-济安金信-东财服务（需要季度日期参数）"""
