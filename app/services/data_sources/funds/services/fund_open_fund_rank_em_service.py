...
from ..providers.fund_open_fund_rank_em_provider import FundOpenFundRankEmProvider

logger = logging.getLogger(__name__)


class FundOpenFundRankEmService:
    """开放式基金排行-东财服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.funds.fund_open_fund_rank_em
        self.provider = FundOpenFundRankEmProvider()
