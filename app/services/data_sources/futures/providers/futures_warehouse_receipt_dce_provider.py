...
class FuturesWarehouseReceiptDceProvider(BaseProvider):
    """仓单日报-大连商品交易所数据提供者"""
    
    collection_name = "futures_warehouse_receipt_dce"
    display_name = "仓单日报-大连商品交易所"
    akshare_func = "futures_dce_warehouse_receipt"
    unique_keys = ["日期", "品种", "仓库"]
    
    collection_description = "大连商品交易所仓单日报数据"
    collection_route = "/futures/collections/futures_warehouse_receipt_dce"
    collection_order = 9
