...
class FuturesShfeWarehouseReceiptProvider(BaseProvider):
    """仓单日报-上海期货交易所数据提供者"""
    ...
    collection_description = "上海期货交易所仓单日报数据"
    collection_route = "/futures/collections/futures_shfe_warehouse_receipt"
    collection_order = 10
