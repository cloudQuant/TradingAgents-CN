...
SERVICES_PACKAGE = "app.services.data_sources.currencies.services"


@lru_cache()
def get_registered_currency_services() -> Dict[str, Type[BaseService]]:
    """
    获取所有已注册的货币数据Service
...
def get_currency_service_by_name(collection_name: str) -> Type[BaseService] | None:
    """根据集合名称获取Service类"""
