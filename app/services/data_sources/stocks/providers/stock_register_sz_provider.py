...
class StockRegisterSzProvider(SimpleProvider):
    """深圳主板数据提供者"""
    
    # 必填属性
    collection_name = "stock_register_sz"
    display_name = "深圳主板"
    akshare_func = "stock_register_sz"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-数据中心-新股数据-IPO审核信息-深圳主板"
    collection_route = "/stocks/collections/stock_register_sz"
