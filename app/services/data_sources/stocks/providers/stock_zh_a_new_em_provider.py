...
class StockZhANewEmProvider(SimpleProvider):
    """新股数据提供者"""
    
    # 必填属性
    collection_name = "stock_zh_a_new_em"
    display_name = "新股"
    akshare_func = "stock_zh_a_new_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-行情中心-沪深个股-新股"
    collection_route = "/stocks/collections/stock_zh_a_new_em"
