...
class StockShASpotEmProvider(SimpleProvider):
    """沪 A 股数据提供者"""
    
    # 必填属性
    collection_name = "stock_sh_a_spot_em"
    display_name = "沪 A 股"
    akshare_func = "stock_sh_a_spot_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-沪 A 股-实时行情数据"
    collection_route = "/stocks/collections/stock_sh_a_spot_em"
