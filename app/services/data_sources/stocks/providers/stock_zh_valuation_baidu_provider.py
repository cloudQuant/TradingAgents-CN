...
class StockZhValuationBaiduProvider(BaseProvider):
    """A 股估值指标数据提供者"""
    
    # 必填属性
    collection_name = "stock_zh_valuation_baidu"
    display_name = "A 股估值指标"
    akshare_func = "stock_zh_valuation_baidu"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "百度股市通-A 股-财务报表-估值数据"
    collection_route = "/stocks/collections/stock_zh_valuation_baidu"
