...
class StockGdfxFreeTop10EmProvider(BaseProvider):
    """十大流通股东(个股)数据提供者"""
    
    # 必填属性
    collection_name = "stock_gdfx_free_top_10_em"
    display_name = "十大流通股东(个股)"
    akshare_func = "stock_gdfx_free_top_10_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-个股-十大流通股东"
    collection_route = "/stocks/collections/stock_gdfx_free_top_10_em"
    ...
    field_info = [
        ...
        {"name": "股东性质", "type": "object", "description": "-"},
        {"name": "股份类型", "type": "object", "description": "-"},
        {"name": "持股数", "type": "int64", "description": "注意单位: 股"},
        {"name": "占总流通股本持股比例", "type": "float64", "description": "注意单位: %"},
