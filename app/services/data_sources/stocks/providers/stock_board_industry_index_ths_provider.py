...
class StockBoardIndustryIndexThsProvider(BaseProvider):
    """同花顺-指数数据提供者"""
    
    # 必填属性
    collection_name = "stock_board_industry_index_ths"
    display_name = "同花顺-指数"
    akshare_func = "stock_board_industry_index_ths"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "同花顺-板块-行业板块-指数日频率数据"
    collection_route = "/stocks/collections/stock_board_industry_index_ths"
