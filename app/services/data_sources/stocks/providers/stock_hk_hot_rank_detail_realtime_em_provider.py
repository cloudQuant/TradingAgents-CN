...
class StockHkHotRankDetailRealtimeEmProvider(BaseProvider):
    """港股数据提供者"""
    
    # 必填属性
    collection_name = "stock_hk_hot_rank_detail_realtime_em"
    display_name = "港股"
    akshare_func = "stock_hk_hot_rank_detail_realtime_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-个股人气榜-实时变动"
    collection_route = "/stocks/collections/stock_hk_hot_rank_detail_realtime_em"
