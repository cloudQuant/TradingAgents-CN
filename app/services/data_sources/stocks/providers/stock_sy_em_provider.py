...
class StockSyEmProvider(BaseProvider):
    """个股商誉明细数据提供者"""
    
    # 必填属性
    collection_name = "stock_sy_em"
    display_name = "个股商誉明细"
    akshare_func = "stock_sy_em"
    unique_keys = ['股票代码']
    
    # 可选属性
    collection_description = "东方财富网-数据中心-特色数据-商誉-个股商誉明细"
    collection_route = "/stocks/collections/stock_sy_em"
    ...
    field_info = [
        ...
        {"name": "净利润同比", "type": "float64", "description": "-"},
        {"name": "上年商誉", "type": "float64", "description": "注意单位: 元"},
