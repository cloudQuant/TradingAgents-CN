...
class StockHkHotRankDetailEmProvider(BaseProvider):
    """港股数据提供者"""
    
    # 必填属性
    collection_name = "stock_hk_hot_rank_detail_em"
    display_name = "港股"
    akshare_func = "stock_hk_hot_rank_detail_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-股票热度-历史趋势"
    collection_route = "/stocks/collections/stock_hk_hot_rank_detail_em"
