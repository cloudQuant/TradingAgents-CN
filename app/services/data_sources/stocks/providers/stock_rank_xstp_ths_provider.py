...
class StockRankXstpThsProvider(BaseProvider):
    """向上突破数据提供者"""
    
    # 必填属性
    collection_name = "stock_rank_xstp_ths"
    display_name = "向上突破"
    akshare_func = "stock_rank_xstp_ths"
    unique_keys = ['股票代码']
    
    # 可选属性
    collection_description = "同花顺-数据中心-技术选股-向上突破"
    collection_route = "/stocks/collections/stock_rank_xstp_ths"
