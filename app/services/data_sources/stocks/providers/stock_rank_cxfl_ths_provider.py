...
class StockRankCxflThsProvider(SimpleProvider):
    """持续放量数据提供者"""
    
    # 必填属性
    collection_name = "stock_rank_cxfl_ths"
    display_name = "持续放量"
    akshare_func = "stock_rank_cxfl_ths"
    unique_keys = ['股票代码']
    
    # 可选属性
    collection_description = "同花顺-数据中心-技术选股-持续放量"
    collection_route = "/stocks/collections/stock_rank_cxfl_ths"
    ...
    field_info = [
        ...
        {"name": "放量天数", "type": "int64", "description": "-"},
