...
class StockZhBMinuteProvider(BaseProvider):
    """分时数据数据提供者"""
    
    # 必填属性
    collection_name = "stock_zh_b_minute"
    display_name = "分时数据"
    akshare_func = "stock_zh_b_minute"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "新浪财经 B 股股票或者指数的分时数据，目前可以获取 1, 5, 15, 30, 60 分钟的数据频率, 可以指定是否复权"
    collection_route = "/stocks/collections/stock_zh_b_minute"
