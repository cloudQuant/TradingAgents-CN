...
class StockGdfxHoldingDetailEmProvider(BaseProvider):
    """股东持股明细-十大股东数据提供者"""
    
    # 必填属性
    collection_name = "stock_gdfx_holding_detail_em"
    display_name = "股东持股明细-十大股东"
    akshare_func = "stock_gdfx_holding_detail_em"
    unique_keys = ['股票代码']
    
    # 可选属性
    collection_description = "东方财富网-数据中心-股东分析-股东持股明细-十大股东"
    collection_route = "/stocks/collections/stock_gdfx_holding_detail_em"
    ...
    # 必填参数
    required_params = ['date', 'indicator', 'symbol']
