...
class StockKcASpotEmProvider(SimpleProvider):
    """科创板数据提供者"""
    
    # 必填属性
    collection_name = "stock_kc_a_spot_em"
    display_name = "科创板"
    akshare_func = "stock_kc_a_spot_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-科创板-实时行情"
    collection_route = "/stocks/collections/stock_kc_a_spot_em"
