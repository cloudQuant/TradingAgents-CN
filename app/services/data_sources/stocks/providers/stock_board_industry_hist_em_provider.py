...
class StockBoardIndustryHistEmProvider(BaseProvider):
    """东方财富-指数-日频数据提供者"""
    
    # 必填属性
    collection_name = "stock_board_industry_hist_em"
    display_name = "东方财富-指数-日频"
    akshare_func = "stock_board_industry_hist_em"
    unique_keys = ['日期']
    
    # 可选属性
    collection_description = "东方财富-沪深板块-行业板块-历史行情数据"
    collection_route = "/stocks/collections/stock_board_industry_hist_em"
    ...
    # 必填参数
    required_params = ['symbol', 'start_date', 'end_date', 'period']
