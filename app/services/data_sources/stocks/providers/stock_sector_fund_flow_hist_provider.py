...
class StockSectorFundFlowHistProvider(BaseProvider):
    """行业历史资金流数据提供者"""
    
    # 必填属性
    collection_name = "stock_sector_fund_flow_hist"
    display_name = "行业历史资金流"
    akshare_func = "stock_sector_fund_flow_hist"
    unique_keys = ['日期']
    
    # 可选属性
    collection_description = "东方财富网-数据中心-资金流向-行业资金流-行业历史资金流"
    collection_route = "/stocks/collections/stock_sector_fund_flow_hist"
