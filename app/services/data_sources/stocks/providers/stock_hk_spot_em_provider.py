...
class StockHkSpotEmProvider(SimpleProvider):
    """实时行情数据-东财数据提供者"""
    
    # 必填属性
    collection_name = "stock_hk_spot_em"
    display_name = "实时行情数据-东财"
    akshare_func = "stock_hk_spot_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "所有港股的实时行情数据; 该数据有 15 分钟延时"
    collection_route = "/stocks/collections/stock_hk_spot_em"
