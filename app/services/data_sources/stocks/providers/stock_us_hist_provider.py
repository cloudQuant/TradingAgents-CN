...
class StockUsHistProvider(BaseProvider):
    """历史行情数据-东财数据提供者"""
    
    # 必填属性
    collection_name = "stock_us_hist"
    display_name = "历史行情数据-东财"
    akshare_func = "stock_us_hist"
    unique_keys = ['日期']
    
    # 可选属性
    collection_description = "东方财富网-行情-美股-每日行情"
    collection_route = "/stocks/collections/stock_us_hist"
