...
class StockIndividualBasicInfoHkXqProvider(BaseProvider):
    """个股信息查询-雪球数据提供者"""
    
    # 必填属性
    collection_name = "stock_individual_basic_info_hk_xq"
    display_name = "个股信息查询-雪球"
    akshare_func = "stock_individual_basic_info_hk_xq"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "雪球-个股-公司概况-公司简介"
    collection_route = "/stocks/collections/stock_individual_basic_info_hk_xq"
