...
class StockZhAGdhsProvider(BaseProvider):
    """股东户数数据提供者"""
    
    # 必填属性
    collection_name = "stock_zh_a_gdhs"
    display_name = "股东户数"
    akshare_func = "stock_zh_a_gdhs"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-数据中心-特色数据-股东户数数据"
    collection_route = "/stocks/collections/stock_zh_a_gdhs"
    ...
    field_info = [
        ...
        {"name": "股东户数统计截止日-本次", "type": "object", "description": "-"},
        {"name": "股东户数统计截止日-上次", "type": "object", "description": "-"},
