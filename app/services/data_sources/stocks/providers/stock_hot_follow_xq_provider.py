...
class StockHotFollowXqProvider(BaseProvider):
    """关注排行榜数据提供者"""
    
    # 必填属性
    collection_name = "stock_hot_follow_xq"
    display_name = "关注排行榜"
    akshare_func = "stock_hot_follow_xq"
    unique_keys = ['股票代码']
    
    # 可选属性
    collection_description = "雪球-沪深股市-热度排行榜-关注排行榜"
    collection_route = "/stocks/collections/stock_hot_follow_xq"
