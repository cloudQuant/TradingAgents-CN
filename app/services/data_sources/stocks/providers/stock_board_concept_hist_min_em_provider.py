...
class StockBoardConceptHistMinEmProvider(BaseProvider):
    """东方财富-指数-分时数据提供者"""
    
    # 必填属性
    collection_name = "stock_board_concept_hist_min_em"
    display_name = "东方财富-指数-分时"
    akshare_func = "stock_board_concept_hist_min_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富-沪深板块-概念板块-分时历史行情数据"
    collection_route = "/stocks/collections/stock_board_concept_hist_min_em"
