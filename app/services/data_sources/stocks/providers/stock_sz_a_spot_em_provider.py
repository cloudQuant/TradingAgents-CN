...
class StockSzASpotEmProvider(SimpleProvider):
    """深 A 股数据提供者"""
    
    # 必填属性
    collection_name = "stock_sz_a_spot_em"
    display_name = "深 A 股"
    akshare_func = "stock_sz_a_spot_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-深 A 股-实时行情数据"
    collection_route = "/stocks/collections/stock_sz_a_spot_em"
