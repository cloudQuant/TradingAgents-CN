...
class StockLhbGgtjSinaProvider(BaseProvider):
    """龙虎榜-个股上榜统计数据提供者"""
    
    # 必填属性
    collection_name = "stock_lhb_ggtj_sina"
    display_name = "龙虎榜-个股上榜统计"
    akshare_func = "stock_lhb_ggtj_sina"
    unique_keys = ['股票代码']
    
    # 可选属性
    collection_description = "新浪财经-龙虎榜-个股上榜统计"
    collection_route = "/stocks/collections/stock_lhb_ggtj_sina"
