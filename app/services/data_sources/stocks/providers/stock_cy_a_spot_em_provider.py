...
class StockCyASpotEmProvider(SimpleProvider):
    """创业板数据提供者"""
    
    # 必填属性
    collection_name = "stock_cy_a_spot_em"
    display_name = "创业板"
    akshare_func = "stock_cy_a_spot_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-创业板-实时行情"
    collection_route = "/stocks/collections/stock_cy_a_spot_em"
