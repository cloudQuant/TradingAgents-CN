...
class StockBoardConceptNameEmProvider(SimpleProvider):
    """东方财富-概念板块数据提供者"""
    
    # 必填属性
    collection_name = "stock_board_concept_name_em"
    display_name = "东方财富-概念板块"
    akshare_func = "stock_board_concept_name_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-行情中心-沪深京板块-概念板块"
    collection_route = "/stocks/collections/stock_board_concept_name_em"
