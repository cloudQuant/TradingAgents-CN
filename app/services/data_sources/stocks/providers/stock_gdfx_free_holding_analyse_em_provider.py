...
class StockGdfxFreeHoldingAnalyseEmProvider(BaseProvider):
    """股东持股分析-十大流通股东数据提供者"""
    
    # 必填属性
    collection_name = "stock_gdfx_free_holding_analyse_em"
    display_name = "股东持股分析-十大流通股东"
    akshare_func = "stock_gdfx_free_holding_analyse_em"
    unique_keys = ['股票代码']
    
    # 可选属性
    collection_description = "东方财富网-数据中心-股东分析-股东持股分析-十大流通股东"
    collection_route = "/stocks/collections/stock_gdfx_free_holding_analyse_em"
    ...
    field_info = [
        ...
        {"name": "公告日后涨跌幅-10个交易日", "type": "float64", "description": "注意单位: %"},
        {"name": "公告日后涨跌幅-30个交易日", "type": "float64", "description": "注意单位: %"},
        {"name": "公告日后涨跌幅-60个交易日", "type": "float64", "description": "注意单位: %"},
