...
class StockFundFlowConceptProvider(BaseProvider):
    """概念资金流数据提供者"""
    
    # 必填属性
    collection_name = "stock_fund_flow_concept"
    display_name = "概念资金流"
    akshare_func = "stock_fund_flow_concept"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "同花顺-数据中心-资金流向-概念资金流"
    collection_route = "/stocks/collections/stock_fund_flow_concept"
    ...
    field_info = [
        ...
        {"name": "行业-涨跌幅", "type": "float64", "description": "注意单位: %"},
        ...
        {"name": "当前价", "type": "float64", "description": "注意单位: 元"},
        {"name": "序号", "type": "int32", "description": "-"},
        {"name": "行业", "type": "object", "description": "-"},
