...
class StockZhBSpotEmProvider(SimpleProvider):
    """实时行情数据-东财数据提供者"""
    
    # 必填属性
    collection_name = "stock_zh_b_spot_em"
    display_name = "实时行情数据-东财"
    akshare_func = "stock_zh_b_spot_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-实时行情数据"
    collection_route = "/stocks/collections/stock_zh_b_spot_em"
