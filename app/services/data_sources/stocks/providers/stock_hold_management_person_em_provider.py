...
class StockHoldManagementPersonEmProvider(BaseProvider):
    """人员增减持股变动明细数据提供者"""
    
    # 必填属性
    collection_name = "stock_hold_management_person_em"
    display_name = "人员增减持股变动明细"
    akshare_func = "stock_hold_management_person_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-数据中心-特色数据-高管持股-人员增减持股变动明细"
    collection_route = "/stocks/collections/stock_hold_management_person_em"
