...
class StockNewASpotEmProvider(SimpleProvider):
    """新股数据提供者"""
    
    # 必填属性
    collection_name = "stock_new_a_spot_em"
    display_name = "新股"
    akshare_func = "stock_new_a_spot_em"
    unique_keys = ['代码']
    
    # 可选属性
    collection_description = "东方财富网-新股-实时行情数据"
    collection_route = "/stocks/collections/stock_new_a_spot_em"
    ...
    field_info = [
        ...
        {"name": "上市时间", "type": "object", "description": "-"},
