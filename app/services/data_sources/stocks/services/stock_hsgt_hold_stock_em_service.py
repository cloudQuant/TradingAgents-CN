...
class StockHsgtHoldStockEmService:
    """Stock Hsgt Hold Stock Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hsgt_hold_stock_em
        self.provider = StockHsgtHoldStockEmProvider()
