...
from ..providers.stock_weekly_provider import StockWeeklyProvider

logger = logging.getLogger(__name__)


class StockWeeklyService:
    """Stock Weekly服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_weekly
        self.provider = StockWeeklyProvider()
