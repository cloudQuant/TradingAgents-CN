...
class StockHkGgtComponentsEmService:
    """Stock Hk Ggt Components Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hk_ggt_components_em
        self.provider = StockHkGgtComponentsEmProvider()
