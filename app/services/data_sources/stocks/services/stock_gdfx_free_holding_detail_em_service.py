...
class StockGdfxFreeHoldingDetailEmService:
    """股东持股明细-十大流通股东服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gdfx_free_holding_detail_em
        self.provider = StockGdfxFreeHoldingDetailEmProvider()
