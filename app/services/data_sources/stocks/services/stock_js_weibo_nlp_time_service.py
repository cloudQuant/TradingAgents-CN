...
from ..providers.stock_js_weibo_nlp_time_provider import StockJsWeiboNlpTimeProvider

logger = logging.getLogger(__name__)


class StockJsWeiboNlpTimeService:
    """Stock Js Weibo Nlp Time服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_js_weibo_nlp_time
        self.provider = StockJsWeiboNlpTimeProvider()
