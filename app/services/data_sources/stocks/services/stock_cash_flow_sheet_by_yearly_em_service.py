"""
Stock Cash Flow Sheet By Yearly Em服务
"""
...
class StockCashFlowSheetByYearlyEmService:
    """Stock Cash Flow Sheet By Yearly Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_cash_flow_sheet_by_yearly_em
        self.provider = StockCashFlowSheetByYearlyEmProvider()
