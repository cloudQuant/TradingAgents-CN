"""
Stock Profit Sheet By Report Delisted Em服务
"""
...
class StockProfitSheetByReportDelistedEmService:
    """Stock Profit Sheet By Report Delisted Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_profit_sheet_by_report_delisted_em
        self.provider = StockProfitSheetByReportDelistedEmProvider()
