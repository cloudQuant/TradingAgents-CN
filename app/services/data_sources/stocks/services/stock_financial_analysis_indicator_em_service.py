"""
Stock Financial Analysis Indicator Em服务
"""
...
class StockFinancialAnalysisIndicatorEmService:
    """Stock Financial Analysis Indicator Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_analysis_indicator_em
        self.provider = StockFinancialAnalysisIndicatorEmProvider()
