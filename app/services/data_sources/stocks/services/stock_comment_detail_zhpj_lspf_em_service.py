...
class StockCommentDetailZhpjLspfEmService:
    """历史评分服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_comment_detail_zhpj_lspf_em
        self.provider = StockCommentDetailZhpjLspfEmProvider()
