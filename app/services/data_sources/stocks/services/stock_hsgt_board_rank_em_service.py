...
class StockHsgtBoardRankEmService:
    """Stock Hsgt Board Rank Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hsgt_board_rank_em
        self.provider = StockHsgtBoardRankEmProvider()
