"""
Stock Balance Sheet By Report Delisted Em服务
"""
...
class StockBalanceSheetByReportDelistedEmService:
    """Stock Balance Sheet By Report Delisted Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_balance_sheet_by_report_delisted_em
        self.provider = StockBalanceSheetByReportDelistedEmProvider()
