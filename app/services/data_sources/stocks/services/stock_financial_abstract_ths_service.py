"""
Stock Financial Abstract Ths服务
"""
...
class StockFinancialAbstractThsService:
    """Stock Financial Abstract Ths服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_abstract_ths
        self.provider = StockFinancialAbstractThsProvider()
