"""
Stock Gdfx Free Holding Change Em服务
"""
...
class StockGdfxFreeHoldingChangeEmService:
    """Stock Gdfx Free Holding Change Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gdfx_free_holding_change_em
        self.provider = StockGdfxFreeHoldingChangeEmProvider()
