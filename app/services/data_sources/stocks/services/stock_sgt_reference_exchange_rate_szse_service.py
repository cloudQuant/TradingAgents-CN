"""
Stock Sgt Reference Exchange Rate Szse服务
"""
...
class StockSgtReferenceExchangeRateSzseService:
    """Stock Sgt Reference Exchange Rate Szse服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_sgt_reference_exchange_rate_szse
        self.provider = StockSgtReferenceExchangeRateSzseProvider()
