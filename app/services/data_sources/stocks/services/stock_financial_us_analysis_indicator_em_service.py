"""
Stock Financial Us Analysis Indicator Em服务
"""
...
class StockFinancialUsAnalysisIndicatorEmService:
    """Stock Financial Us Analysis Indicator Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_us_analysis_indicator_em
        self.provider = StockFinancialUsAnalysisIndicatorEmProvider()
