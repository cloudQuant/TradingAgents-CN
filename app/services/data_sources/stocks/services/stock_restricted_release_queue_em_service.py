"""
Stock Restricted Release Queue Em服务
"""
...
class StockRestrictedReleaseQueueEmService:
    """Stock Restricted Release Queue Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_restricted_release_queue_em
        self.provider = StockRestrictedReleaseQueueEmProvider()
