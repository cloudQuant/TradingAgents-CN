...
from ..providers.stock_info_change_name_em_provider import StockInfoChangeNameEmProvider

logger = logging.getLogger(__name__)


class StockInfoChangeNameEmService:
    """Stock Info Change Name Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_info_change_name_em
        self.provider = StockInfoChangeNameEmProvider()
