...
class StockABelowNetAssetStatisticsService:
    """破净股统计服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_a_below_net_asset_statistics
        self.provider = StockABelowNetAssetStatisticsProvider()
