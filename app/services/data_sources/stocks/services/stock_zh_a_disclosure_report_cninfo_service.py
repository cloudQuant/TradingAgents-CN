...
class StockZhADisclosureReportCninfoService:
    """信息披露公告-巨潮资讯服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_zh_a_disclosure_report_cninfo
        self.provider = StockZhADisclosureReportCninfoProvider()
