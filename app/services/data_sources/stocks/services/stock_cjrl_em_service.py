...
from ..providers.stock_cjrl_em_provider import StockCjrlEmProvider

logger = logging.getLogger(__name__)


class StockCjrlEmService:
    """Stock Cjrl Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_cjrl_em
        self.provider = StockCjrlEmProvider()
