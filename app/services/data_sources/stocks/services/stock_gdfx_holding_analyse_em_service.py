"""
Stock Gdfx Holding Analyse Em服务
"""
...
class StockGdfxHoldingAnalyseEmService:
    """Stock Gdfx Holding Analyse Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gdfx_holding_analyse_em
        self.provider = StockGdfxHoldingAnalyseEmProvider()
