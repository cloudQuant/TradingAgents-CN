"""
Stock Balance Sheet By Report Em服务
"""
...
class StockBalanceSheetByReportEmService:
    """Stock Balance Sheet By Report Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_balance_sheet_by_report_em
        self.provider = StockBalanceSheetByReportEmProvider()
