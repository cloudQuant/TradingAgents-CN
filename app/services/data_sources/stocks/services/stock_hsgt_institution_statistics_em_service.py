"""
Stock Hsgt Institution Statistics Em服务
"""
...
class StockHsgtInstitutionStatisticsEmService:
    """Stock Hsgt Institution Statistics Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hsgt_institution_statistics_em
        self.provider = StockHsgtInstitutionStatisticsEmProvider()
