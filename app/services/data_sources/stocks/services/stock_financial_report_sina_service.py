...
from ..providers.stock_financial_report_sina_provider import StockFinancialReportSinaProvider

logger = logging.getLogger(__name__)


class StockFinancialReportSinaService:
    """Stock Financial Report Sina服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_report_sina
        self.provider = StockFinancialReportSinaProvider()
