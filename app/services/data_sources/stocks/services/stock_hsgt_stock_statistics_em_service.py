"""
Stock Hsgt Stock Statistics Em服务
"""
...
class StockHsgtStockStatisticsEmService:
    """Stock Hsgt Stock Statistics Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hsgt_stock_statistics_em
        self.provider = StockHsgtStockStatisticsEmProvider()
