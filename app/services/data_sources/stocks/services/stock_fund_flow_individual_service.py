...
class StockFundFlowIndividualService:
    """Stock Fund Flow Individual服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_fund_flow_individual
        self.provider = StockFundFlowIndividualProvider()
