...
class StockZhADisclosureRelationCninfoService:
    """信息披露调研-巨潮资讯服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_zh_a_disclosure_relation_cninfo
        self.provider = StockZhADisclosureRelationCninfoProvider()
