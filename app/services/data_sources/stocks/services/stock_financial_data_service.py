...
from ..providers.stock_financial_data_provider import StockFinancialDataProvider

logger = logging.getLogger(__name__)


class StockFinancialDataService:
    """Stock Financial Data服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_data
        self.provider = StockFinancialDataProvider()
