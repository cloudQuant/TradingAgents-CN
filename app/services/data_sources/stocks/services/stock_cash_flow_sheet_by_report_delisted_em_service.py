"""
Stock Cash Flow Sheet By Report Delisted Em服务
"""
...
class StockCashFlowSheetByReportDelistedEmService:
    """Stock Cash Flow Sheet By Report Delisted Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_cash_flow_sheet_by_report_delisted_em
        self.provider = StockCashFlowSheetByReportDelistedEmProvider()
