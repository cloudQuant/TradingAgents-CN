...
class StockFinancialDebtThsService:
    """Stock Financial Debt Ths服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_debt_ths
        self.provider = StockFinancialDebtThsProvider()
