"""
Stock Sector Fund Flow Summary服务
"""
...
class StockSectorFundFlowSummaryService:
    """Stock Sector Fund Flow Summary服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_sector_fund_flow_summary
        self.provider = StockSectorFundFlowSummaryProvider()
