"""
Stock Financial Analysis Indicator服务
"""
...
class StockFinancialAnalysisIndicatorService:
    """Stock Financial Analysis Indicator服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_analysis_indicator
        self.provider = StockFinancialAnalysisIndicatorProvider()
