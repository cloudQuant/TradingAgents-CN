...
class StockCommentDetailScrdDesireEmService:
    """市场参与意愿服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_comment_detail_scrd_desire_em
        self.provider = StockCommentDetailScrdDesireEmProvider()
