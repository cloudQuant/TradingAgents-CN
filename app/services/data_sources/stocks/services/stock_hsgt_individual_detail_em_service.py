"""
Stock Hsgt Individual Detail Em服务
"""
...
class StockHsgtIndividualDetailEmService:
    """Stock Hsgt Individual Detail Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hsgt_individual_detail_em
        self.provider = StockHsgtIndividualDetailEmProvider()
