...
from ..providers.stock_em_hsgt_hold_stock_provider import StockEmHsgtHoldStockProvider

logger = logging.getLogger(__name__)


class StockEmHsgtHoldStockService:
    """Stock Em Hsgt Hold Stock服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_em_hsgt_hold_stock
        self.provider = StockEmHsgtHoldStockProvider()
