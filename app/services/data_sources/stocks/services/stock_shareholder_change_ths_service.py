"""
Stock Shareholder Change Ths服务
"""
...
class StockShareholderChangeThsService:
    """Stock Shareholder Change Ths服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_shareholder_change_ths
        self.provider = StockShareholderChangeThsProvider()
