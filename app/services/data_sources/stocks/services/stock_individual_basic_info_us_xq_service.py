...
from ..providers.stock_individual_basic_info_us_xq_provider import StockIndividualBasicInfoUsXqProvider

logger = logging.getLogger(__name__)


class StockIndividualBasicInfoUsXqService:
    """个股信息查询-雪球服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_individual_basic_info_us_xq
        self.provider = StockIndividualBasicInfoUsXqProvider()
