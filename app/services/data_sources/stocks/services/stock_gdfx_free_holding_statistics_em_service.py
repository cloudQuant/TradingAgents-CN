...
class StockGdfxFreeHoldingStatisticsEmService:
    """股东持股统计-十大流通股东服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gdfx_free_holding_statistics_em
        self.provider = StockGdfxFreeHoldingStatisticsEmProvider()
