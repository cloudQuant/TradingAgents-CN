...
class StockHsgtIndividualEmService:
    """Stock Hsgt Individual Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hsgt_individual_em
        self.provider = StockHsgtIndividualEmProvider()
