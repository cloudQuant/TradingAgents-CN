"""
Stock Financial Hk Report Em服务
"""
...
class StockFinancialHkReportEmService:
    """Stock Financial Hk Report Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_hk_report_em
        self.provider = StockFinancialHkReportEmProvider()
