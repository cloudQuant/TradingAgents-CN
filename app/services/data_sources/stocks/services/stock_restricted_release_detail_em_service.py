...
class StockRestrictedReleaseDetailEmService:
    """限售股解禁详情服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_restricted_release_detail_em
        self.provider = StockRestrictedReleaseDetailEmProvider()
