"""
Stock Financial Hk Analysis Indicator Em服务
"""
...
class StockFinancialHkAnalysisIndicatorEmService:
    """Stock Financial Hk Analysis Indicator Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_hk_analysis_indicator_em
        self.provider = StockFinancialHkAnalysisIndicatorEmProvider()
