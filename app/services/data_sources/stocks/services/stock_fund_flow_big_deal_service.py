...
class StockFundFlowBigDealService:
    """Stock Fund Flow Big Deal服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_fund_flow_big_deal
        self.provider = StockFundFlowBigDealProvider()
