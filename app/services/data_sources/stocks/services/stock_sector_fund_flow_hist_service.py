...
class StockSectorFundFlowHistService:
    """Stock Sector Fund Flow Hist服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_sector_fund_flow_hist
        self.provider = StockSectorFundFlowHistProvider()
