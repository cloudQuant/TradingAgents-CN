...
class StockGdfxFreeHoldingTeamworkEmService:
    """股东协同-十大流通股东服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gdfx_free_holding_teamwork_em
        self.provider = StockGdfxFreeHoldingTeamworkEmProvider()
