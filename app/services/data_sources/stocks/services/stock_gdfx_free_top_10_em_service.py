...
class StockGdfxFreeTop10EmService:
    """Stock Gdfx Free Top 10 Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gdfx_free_top_10_em
        self.provider = StockGdfxFreeTop10EmProvider()
