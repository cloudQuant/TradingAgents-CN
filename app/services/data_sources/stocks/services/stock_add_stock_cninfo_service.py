...
from ..providers.stock_add_stock_cninfo_provider import StockAddStockCninfoProvider

logger = logging.getLogger(__name__)


class StockAddStockCninfoService:
    """Stock Add Stock Cninfo服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_add_stock_cninfo
        self.provider = StockAddStockCninfoProvider()
