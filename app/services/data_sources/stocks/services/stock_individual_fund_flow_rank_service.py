"""
Stock Individual Fund Flow Rank服务
"""
...
class StockIndividualFundFlowRankService:
    """Stock Individual Fund Flow Rank服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_individual_fund_flow_rank
        self.provider = StockIndividualFundFlowRankProvider()
