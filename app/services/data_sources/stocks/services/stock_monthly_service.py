...
from ..providers.stock_monthly_provider import StockMonthlyProvider

logger = logging.getLogger(__name__)


class StockMonthlyService:
    """Stock Monthly服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_monthly
        self.provider = StockMonthlyProvider()
