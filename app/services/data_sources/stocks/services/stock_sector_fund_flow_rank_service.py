...
from ..providers.stock_sector_fund_flow_rank_provider import StockSectorFundFlowRankProvider

logger = logging.getLogger(__name__)


class StockSectorFundFlowRankService:
    """Stock Sector Fund Flow Rank服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_sector_fund_flow_rank
        self.provider = StockSectorFundFlowRankProvider()
