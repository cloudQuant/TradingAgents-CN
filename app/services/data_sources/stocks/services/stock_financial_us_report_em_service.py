"""
Stock Financial Us Report Em服务
"""
...
class StockFinancialUsReportEmService:
    """Stock Financial Us Report Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_us_report_em
        self.provider = StockFinancialUsReportEmProvider()
