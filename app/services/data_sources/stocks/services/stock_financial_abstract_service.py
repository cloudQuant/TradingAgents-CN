...
class StockFinancialAbstractService:
    """Stock Financial Abstract服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_abstract
        self.provider = StockFinancialAbstractProvider()
