...
class StockManagementChangeThsService:
    """Stock Management Change Ths服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_management_change_ths
        self.provider = StockManagementChangeThsProvider()
