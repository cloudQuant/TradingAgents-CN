"""
Stock Profit Sheet By Quarterly Em服务
"""
...
class StockProfitSheetByQuarterlyEmService:
    """Stock Profit Sheet By Quarterly Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_profit_sheet_by_quarterly_em
        self.provider = StockProfitSheetByQuarterlyEmProvider()
