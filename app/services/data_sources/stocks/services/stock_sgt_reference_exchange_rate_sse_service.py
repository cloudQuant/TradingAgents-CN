"""
Stock Sgt Reference Exchange Rate Sse服务
"""
...
class StockSgtReferenceExchangeRateSseService:
    """Stock Sgt Reference Exchange Rate Sse服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_sgt_reference_exchange_rate_sse
        self.provider = StockSgtReferenceExchangeRateSseProvider()
