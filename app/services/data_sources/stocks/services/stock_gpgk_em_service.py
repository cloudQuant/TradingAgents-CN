...
from ..providers.stock_gpgk_em_provider import StockGpgkEmProvider

logger = logging.getLogger(__name__)


class StockGpgkEmService:
    """Stock Gpgk Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gpgk_em
        self.provider = StockGpgkEmProvider()
