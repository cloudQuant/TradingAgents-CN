...
class StockIndividualBasicInfoHkXqService:
    """个股信息查询-雪球服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_individual_basic_info_hk_xq
        self.provider = StockIndividualBasicInfoHkXqProvider()
