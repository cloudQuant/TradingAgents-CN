...
class StockFinancialBenefitThsService:
    """Stock Financial Benefit Ths服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_financial_benefit_ths
        self.provider = StockFinancialBenefitThsProvider()
