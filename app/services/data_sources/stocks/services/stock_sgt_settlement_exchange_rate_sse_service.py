...
from .providers.stock_sgt_settlement_exchange_rate_sse_provider import StockSgtSettlementExchangeRateSseProvider

logger = logging.getLogger(__name__)


class StockSgtSettlementExchangeRateSseService:
    """结算汇率-沪港通服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_sgt_settlement_exchange_rate_sse
        self.provider = StockSgtSettlementExchangeRateSseProvider()
