"""
Stock Em Hsgt North Net Flow In服务
"""
...
from ..providers.stock_em_hsgt_north_net_flow_in_provider import StockEmHsgtNorthNetFlowInProvider

logger = logging.getLogger(__name__)


class StockEmHsgtNorthNetFlowInService:
    """Stock Em Hsgt North Net Flow In服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_em_hsgt_north_net_flow_in
        self.provider = StockEmHsgtNorthNetFlowInProvider()
