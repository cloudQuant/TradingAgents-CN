"""
Stock Em Hsgt South Net Flow In服务
"""
...
from ..providers.stock_em_hsgt_south_net_flow_in_provider import StockEmHsgtSouthNetFlowInProvider

logger = logging.getLogger(__name__)


class StockEmHsgtSouthNetFlowInService:
    """Stock Em Hsgt South Net Flow In服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_em_hsgt_south_net_flow_in
        self.provider = StockEmHsgtSouthNetFlowInProvider()
