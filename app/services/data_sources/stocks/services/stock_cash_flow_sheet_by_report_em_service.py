"""
Stock Cash Flow Sheet By Report Em服务
"""
...
class StockCashFlowSheetByReportEmService:
    """Stock Cash Flow Sheet By Report Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_cash_flow_sheet_by_report_em
        self.provider = StockCashFlowSheetByReportEmProvider()
