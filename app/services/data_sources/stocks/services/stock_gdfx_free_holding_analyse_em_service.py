"""
Stock Gdfx Free Holding Analyse Em服务
"""
...
class StockGdfxFreeHoldingAnalyseEmService:
    """Stock Gdfx Free Holding Analyse Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gdfx_free_holding_analyse_em
        self.provider = StockGdfxFreeHoldingAnalyseEmProvider()
