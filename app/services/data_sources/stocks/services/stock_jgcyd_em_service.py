...
from ..providers.stock_jgcyd_em_provider import StockJgcydEmProvider

logger = logging.getLogger(__name__)


class StockJgcydEmService:
    """Stock Jgcyd Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_jgcyd_em
        self.provider = StockJgcydEmProvider()
