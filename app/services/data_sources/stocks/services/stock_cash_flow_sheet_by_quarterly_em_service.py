"""
Stock Cash Flow Sheet By Quarterly Em服务
"""
...
class StockCashFlowSheetByQuarterlyEmService:
    """Stock Cash Flow Sheet By Quarterly Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_cash_flow_sheet_by_quarterly_em
        self.provider = StockCashFlowSheetByQuarterlyEmProvider()
