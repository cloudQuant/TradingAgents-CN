...
class StockMarginUnderlyingInfoSzseService:
    """标的证券信息服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_margin_underlying_info_szse
        self.provider = StockMarginUnderlyingInfoSzseProvider()
