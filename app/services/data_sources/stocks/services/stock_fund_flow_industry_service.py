...
class StockFundFlowIndustryService:
    """Stock Fund Flow Industry服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_fund_flow_industry
        self.provider = StockFundFlowIndustryProvider()
