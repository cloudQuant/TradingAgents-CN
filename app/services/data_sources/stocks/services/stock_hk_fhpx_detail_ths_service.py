...
class StockHkFhpxDetailThsService:
    """Stock Hk Fhpx Detail Ths服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_hk_fhpx_detail_ths
        self.provider = StockHkFhpxDetailThsProvider()
