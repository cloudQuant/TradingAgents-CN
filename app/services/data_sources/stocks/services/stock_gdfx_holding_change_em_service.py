"""
Stock Gdfx Holding Change Em服务
"""
...
class StockGdfxHoldingChangeEmService:
    """Stock Gdfx Holding Change Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_gdfx_holding_change_em
        self.provider = StockGdfxHoldingChangeEmProvider()
