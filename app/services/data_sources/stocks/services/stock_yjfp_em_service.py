...
from ..providers.stock_yjfp_em_provider import StockYjfpEmProvider

logger = logging.getLogger(__name__)


class StockYjfpEmService:
    """Stock Yjfp Em服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_yjfp_em
        self.provider = StockYjfpEmProvider()
