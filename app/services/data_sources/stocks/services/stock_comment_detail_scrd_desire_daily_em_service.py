...
class StockCommentDetailScrdDesireDailyEmService:
    """日度市场参与意愿服务"""
    
    def __init__(self, db: AsyncIOMotorClient):
        self.db = db
        self.collection = db.stocks.stock_comment_detail_scrd_desire_daily_em
        self.provider = StockCommentDetailScrdDesireDailyEmProvider()
