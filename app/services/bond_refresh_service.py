...
from app.services.data_sources.bonds.service_registry import get_service_class
...
class BondRefreshService:
    ...
    async def get_collection_overview(self, collection_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise BondDataUpdateError(f"获取概览失败: {str(e)}", collection_name)
    ...
    async def refresh_collection(
        ...
        try:
            ...
            raise BondDataUpdateError(str(e), collection_name)
    ...
    def get_collection_count(self) -> int:
        """获取支持的数据集合数量"""
        return len(get_collection_definitions())
