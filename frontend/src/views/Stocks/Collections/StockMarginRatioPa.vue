<template>
  <div class="stock_margin_ratio_pa-container">
    <el-card class="header-card">
      <h2>标的证券名单及保证金比例查询</h2>
    </el-card>
...
const API_BASE = '/api/stocks/collections/stock_margin_ratio_pa'
...
<style scoped>
.stock_margin_ratio_pa-container {
  padding: 20px;
}
