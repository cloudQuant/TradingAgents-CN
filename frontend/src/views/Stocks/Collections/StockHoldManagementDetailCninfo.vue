<template>
  <div class="stock_hold_management_detail_cninfo-container">
...
const API_BASE = '/api/stocks/collections/stock_hold_management_detail_cninfo'
...
<style scoped>
.stock_hold_management_detail_cninfo-container {
  padding: 20px;
}
