<template>
  <div class="stock_restricted_release_stockholder_em-container">
...
const API_BASE = '/api/stocks/collections/stock_restricted_release_stockholder_em'
...
<style scoped>
.stock_restricted_release_stockholder_em-container {
  padding: 20px;
}
