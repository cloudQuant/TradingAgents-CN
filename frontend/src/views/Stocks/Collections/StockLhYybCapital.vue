<template>
  <div class="stock_lh_yyb_capital-container">
    <el-card class="header-card">
      <h2>龙虎榜-营业部排行-资金实力最强</h2>
    </el-card>
...
const API_BASE = '/api/stocks/collections/stock_lh_yyb_capital'
...
<style scoped>
.stock_lh_yyb_capital-container {
  padding: 20px;
}
