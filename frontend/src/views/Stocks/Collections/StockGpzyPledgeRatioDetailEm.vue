<template>
  <div class="stock_gpzy_pledge_ratio_detail_em-container">
...
const API_BASE = '/api/stocks/collections/stock_gpzy_pledge_ratio_detail_em'
...
<style scoped>
.stock_gpzy_pledge_ratio_detail_em-container {
  padding: 20px;
}
