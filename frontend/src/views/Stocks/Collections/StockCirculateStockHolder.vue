<template>
  <div class="stock_circulate_stock_holder-container">
...
const API_BASE = '/api/stocks/collections/stock_circulate_stock_holder'
...
<style scoped>
.stock_circulate_stock_holder-container {
  padding: 20px;
}
