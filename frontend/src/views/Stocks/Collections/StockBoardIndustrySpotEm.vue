<template>
  <div class="stock_board_industry_spot_em-container">
    <el-card class="header-card">
      <h2>东方财富-行业板块-实时行情</h2>
    </el-card>
...
const API_BASE = '/api/stocks/collections/stock_board_industry_spot_em'
...
<style scoped>
.stock_board_industry_spot_em-container {
  padding: 20px;
}
