<template>
  <div class="stock_industry_pe_ratio_cninfo-container">
...
const API_BASE = '/api/stocks/collections/stock_industry_pe_ratio_cninfo'
...
<style scoped>
.stock_industry_pe_ratio_cninfo-container {
  padding: 20px;
}
