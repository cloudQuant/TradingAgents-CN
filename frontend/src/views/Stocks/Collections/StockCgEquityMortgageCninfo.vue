<template>
  <div class="stock_cg_equity_mortgage_cninfo-container">
...
const API_BASE = '/api/stocks/collections/stock_cg_equity_mortgage_cninfo'
...
<style scoped>
.stock_cg_equity_mortgage_cninfo-container {
  padding: 20px;
}
