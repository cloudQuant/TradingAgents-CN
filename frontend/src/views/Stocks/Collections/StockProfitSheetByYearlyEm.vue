<template>
  <div class="stock_profit_sheet_by_yearly_em-container">
...
const API_BASE = '/api/stocks/collections/stock_profit_sheet_by_yearly_em'
...
<style scoped>
.stock_profit_sheet_by_yearly_em-container {
  padding: 20px;
}
