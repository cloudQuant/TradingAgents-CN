<template>
  <div class="stock_sgt_settlement_exchange_rate_sse-container">
...
const API_BASE = '/api/stocks/collections/stock_sgt_settlement_exchange_rate_sse'
...
<style scoped>
.stock_sgt_settlement_exchange_rate_sse-container {
  padding: 20px;
}
