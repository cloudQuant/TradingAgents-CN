<template>
  <div class="stock_individual_basic_info_xq-container">
...
const API_BASE = '/api/stocks/collections/stock_individual_basic_info_xq'
...
<style scoped>
.stock_individual_basic_info_xq-container {
  padding: 20px;
}
