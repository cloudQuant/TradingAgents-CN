<template>
  <div class="stock_comment_detail_zhpj_lspf_em-container">
...
const API_BASE = '/api/stocks/collections/stock_comment_detail_zhpj_lspf_em'
...
<style scoped>
.stock_comment_detail_zhpj_lspf_em-container {
  padding: 20px;
}
