<template>
  <div class="stock_comment_detail_scrd_desire_em-container">
...
const API_BASE = '/api/stocks/collections/stock_comment_detail_scrd_desire_em'
...
<style scoped>
.stock_comment_detail_scrd_desire_em-container {
  padding: 20px;
}
