<template>
  <div class="stock_share_hold_change_sse-container">
    <el-card class="header-card">
      <h2>董监高及相关人员持股变动-上证</h2>
    </el-card>
...
const API_BASE = '/api/stocks/collections/stock_share_hold_change_sse'
...
<style scoped>
.stock_share_hold_change_sse-container {
  padding: 20px;
}
