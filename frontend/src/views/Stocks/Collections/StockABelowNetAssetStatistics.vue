<template>
  <div class="stock_a_below_net_asset_statistics-container">
...
const API_BASE = '/api/stocks/collections/stock_a_below_net_asset_statistics'
...
<style scoped>
.stock_a_below_net_asset_statistics-container {
  padding: 20px;
}
