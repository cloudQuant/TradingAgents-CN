<template>
  <div class="stock_margin_underlying_info_szse-container">
...
const API_BASE = '/api/stocks/collections/stock_margin_underlying_info_szse'
...
<style scoped>
.stock_margin_underlying_info_szse-container {
  padding: 20px;
}
