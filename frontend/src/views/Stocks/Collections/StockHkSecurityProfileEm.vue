<template>
  <div class="stock_hk_security_profile_em-container">
...
const API_BASE = '/api/stocks/collections/stock_hk_security_profile_em'
...
<style scoped>
.stock_hk_security_profile_em-container {
  padding: 20px;
}
