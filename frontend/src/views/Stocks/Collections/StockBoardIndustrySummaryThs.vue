<template>
  <div class="stock_board_industry_summary_ths-container">
...
const API_BASE = '/api/stocks/collections/stock_board_industry_summary_ths'
...
<style scoped>
.stock_board_industry_summary_ths-container {
  padding: 20px;
}
