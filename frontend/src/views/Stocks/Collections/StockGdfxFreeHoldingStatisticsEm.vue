<template>
  <div class="stock_gdfx_free_holding_statistics_em-container">
...
const API_BASE = '/api/stocks/collections/stock_gdfx_free_holding_statistics_em'
...
<style scoped>
.stock_gdfx_free_holding_statistics_em-container {
  padding: 20px;
}
