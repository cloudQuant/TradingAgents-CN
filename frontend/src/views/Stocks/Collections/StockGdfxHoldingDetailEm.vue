<template>
  <div class="stock_gdfx_holding_detail_em-container">
...
const API_BASE = '/api/stocks/collections/stock_gdfx_holding_detail_em'
...
<style scoped>
.stock_gdfx_holding_detail_em-container {
  padding: 20px;
}
