<template>
  <div class="stock_zh_growth_comparison_em-container">
...
const API_BASE = '/api/stocks/collections/stock_zh_growth_comparison_em'
...
<style scoped>
.stock_zh_growth_comparison_em-container {
  padding: 20px;
}
