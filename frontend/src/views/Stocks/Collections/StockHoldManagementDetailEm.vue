<template>
  <div class="stock_hold_management_detail_em-container">
    <el-card class="header-card">
      <h2>董监高及相关人员持股变动明细</h2>
    </el-card>
...
const API_BASE = '/api/stocks/collections/stock_hold_management_detail_em'
...
<style scoped>
.stock_hold_management_detail_em-container {
  padding: 20px;
}
