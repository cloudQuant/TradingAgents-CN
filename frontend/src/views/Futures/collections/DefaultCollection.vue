...
import { CollectionPageHeader, CollectionDataTable, CollectionOverviewDialog, FileImportDialog, RemoteSyncDialog, useFuturesCollection } from '@/components/collection'
...
} = useFuturesCollection()

const futuresStore = useFuturesStore()

onMounted(() => { futuresStore.loadCollections(); loadData() })
onUnmounted(() => { cleanup() })
</script>
