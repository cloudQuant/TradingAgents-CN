...
│  ┌──────────────────────┐  ┌──────────────────────┐            │
│  │  process_task (协程 1)│  │  process_task (协程 2)│  ...      │
│  │  - 获取基金 A 数据     │  │  - 获取基金 B 数据     │            │
...
├─ 获取数据 ────────────────────────────────────────────────┤
│                                                              │
│  累积数据: [1000 行] [1500 行] [800 行] [1200 行] [1000 行]     │
│            │                                                │
│            └─ 达到 5000 行阈值 ──> 立即保存                │
│                                                              │
└─ 5 秒间隔 ────────────────────────────────────────────────> 保存
...
数据: 3300 条记录
│
├─ 第 1 批: 1000 条 → bulk_write → 结果 1
├─ 第 2 批: 1000 条 → bulk_write → 结果 2
├─ 第 3 批: 1000 条 → bulk_write → 结果 3
└─ 第 4 批: 300 条  → bulk_write → 结果 4
│
