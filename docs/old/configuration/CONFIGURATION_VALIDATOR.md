...
| `MONGODB_HOST` | MongoDB 主机地址 | `localhost` | 非空 |

| `MONGODB_PORT` | MongoDB 端口 | `27017` | 1-65535 |

| `MONGODB_DATABASE` | MongoDB 数据库名称 | `tradingagents` | 非空 |

| `REDIS_HOST` | Redis 主机地址 | `localhost` | 非空 |

| `REDIS_PORT` | Redis 端口 | `6379` | 1-65535 |

| `JWT_SECRET` | JWT 密钥 | `xxx` | ≥16 字符 |
...
| `DASHSCOPE_API_KEY` | 阿里百炼 API 密钥 | <https://dashscope.aliyun.com/> |
