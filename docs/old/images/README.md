...
此目录用于存放 TradingAgents-CN Web 界面的截图文件。

## 📸 需要的截图文件

为了完善 README.md 中的 Web 界面展示，请添加以下截图：
...
当 Web 界面有重大更新时，请及时更新对应的截图，确保文档与实际界面保持一致。

- --

- *注意**: 此目录中的截图将在 README.md 中展示，代表项目的专业形象，请确保截图质量和内容的专业性。
