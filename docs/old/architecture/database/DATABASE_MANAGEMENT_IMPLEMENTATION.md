...
将原本的静态展示数据库管理页面改造为真正可用的数据库管理系统，支持 MongoDB 和 Redis 的监控、备份、导入导出等功能。
...
```bash
app/
├── routers/database.py          # 数据库管理 API 路由
