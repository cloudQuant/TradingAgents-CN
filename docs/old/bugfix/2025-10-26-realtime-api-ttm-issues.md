...
# 计算 PE = 股价 / 每股收益
            pe_val = price_value / eps_val  # ❌ 使用单期 EPS
...
1. 修改 `_parse_financial_data` 方法（Tushare）
   - 获取最近 4 期的利润表数据
