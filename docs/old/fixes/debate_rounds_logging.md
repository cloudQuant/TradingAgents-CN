...
用户选择了 4 级深度分析（应该有 2 轮投资辩论和 2 轮风险讨论），但实际执行时只进行了 1 轮。

## 修复内容

### 1. 核心问题修复

- *文件**: `tradingagents/graph/trading_graph.py` (第 262 行)
