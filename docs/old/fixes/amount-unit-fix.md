...
if amount_value is not None and data_source == "tushare":
    ...
    logger.debug(f"📊 [单位转换] Tushare 成交额: {amount_value/1000:.2f}千元 -> {amount_value:.2f}元")
...
💡 验证标准:
   ...
   - 如果成交额显示为 90.92 亿 左右，说明修复成功 ✅
   - 如果成交额显示为 909.18 万 或 0.0091 亿，说明仍有问题 ❌
...
| Tushare | **千元** | 元 | × 1000 | [Tushare 日线行情](<https://tushare.pro/document/2?doc_id=27)> |

| AKShare | 元 | 元 | × 1 | [AKShare 股票数据](<https://akshare.akfamily.xyz/data/stock/stock.html)> |

| BaoStock | 元 | 元 | × 1 | [BaoStock API 文档](<http://baostock.com/baostock/index.php/Python_API%E6%96%87%E6%A1%A3)> |
