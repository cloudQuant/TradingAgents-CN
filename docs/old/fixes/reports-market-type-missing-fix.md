...
```bash
🔍 获取报告列表: 用户=xxx, 页码=1, 每页=20, 市场=A 股
📊 查询条件: {"market_type": "A 股"}
✅ 查询完成: 总数=0, 返回=0
...
1. `app/routers/reports.py`
   - 第 141-179 行：查询时兼容旧数据，动态推断市场类型

### Web

1. `web/utils/mongodb_report_manager.py`
   - 第 109-168 行：添加市场类型推断和字段

### 测试

1. `scripts/test_market_type_fix.py`
   - 新增测试脚本

### 文档

1. `docs/fixes/reports-market-type-missing-fix.md`
   - 本文档
