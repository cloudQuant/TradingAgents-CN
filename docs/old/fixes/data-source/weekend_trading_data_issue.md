...
```bash
2025-10-13 06:45:25,711 | dataflows | INFO | 📊 [数据来源: mongodb] 开始获取 daily 数据: 600519

2025-10-13 06:45:25,724 | dataflows | WARNING | ⚠️ [数据来源: MongoDB] 未找到 daily 数据: 600519，降级到其他数据源

2025-10-13 06:45:26,657 | tradingagents.dataflows.providers.china.akshare | WARNING | ⚠️ 600519 历史数据为空
...
# 旧代码（app/services/simple_analysis_service.py 第 961 行）
