...
用户反馈：输入港股代码 `00700`（5 位数字），但分析工具无法识别，显示为"未知市场"，然后按美股处理。
...
# 港股：4-5 位数字.HK（支持 0700.HK 和 09988.HK 格式）
...
# 港股：4-5 位数字.HK 或 纯 4-5 位数字（支持 0700.HK、09988.HK、00700、9988 格式）
