...
|**setup_embedded_python.ps1**| `scripts/deployment/` | 下载并配置嵌入式 Python |

|**update_scripts_for_embedded_python.ps1**| `scripts/deployment/` | 更新启动脚本使用嵌入式 Python |
...
|**build_portable_package.ps1**| 添加嵌入式 Python 自动安装和集成 |
...
|**portable-python-independence.md**| `docs/deployment/` | Python 独立性技术分析 |

|**EMBEDDED_PYTHON_GUIDE.md**| `docs/deployment/` | 嵌入式 Python 详细指南 |
...
> "用户的电脑上没有安装 python 或者 python 的版本不一样能不能运行起来"
