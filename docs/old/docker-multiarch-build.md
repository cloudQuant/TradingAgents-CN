...
云子量化 现在支持多架构 Docker 镜像构建，可以在 AMD64 (x86_64) 和 ARM64 (ARM) 架构上运行。
...
| `linux/arm64` | ARM 64 位架构 | ARM 服务器、树莓派 4/5、NVIDIA Jetson、Apple Silicon (M1/M2/M3) |
...
1. **使用 CI/CD 自动构建**（GitHub Actions、GitLab CI 等）
