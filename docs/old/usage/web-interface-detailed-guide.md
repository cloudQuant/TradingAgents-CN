...
> 📖 **完整指南**: TradingAgents-CN Web 界面的详细使用说明和最佳实践

## 🎯 界面概览

TradingAgents-CN Web 界面是基于 Streamlit 构建的现代化股票分析平台，提供直观、专业的用户体验。
...
- **Google AI**
  - 模型: gemini-2.5-pro, gemini-2.0-flash 等
  - 特点: 最新技术，多模态支持
