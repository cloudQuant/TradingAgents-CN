...
## 🔄 任务 1: 股票基础信息同步 (BasicsSyncService)

### 📝 功能说明

- *任务 ID**: `basics_sync_service`
...
## 📈 任务 2: 实时行情入库 (QuotesIngestionService)

### 📝 功能说明

- *任务 ID**: `quotes_ingestion_service`
...
| `SYNC_STOCK_BASICS_TIME` | string | `"06:30"` | 执行时间（HH:MM 格式） |

| `SYNC_STOCK_BASICS_CRON` | string | `""` | CRON 表达式（优先级高于 TIME） |
