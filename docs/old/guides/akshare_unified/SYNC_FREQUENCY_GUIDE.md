...
tail -f logs/app.log | grep "AKShare 行情同步"
...
| 每 5 分钟 | 1 | ~30 秒 | 高 ⚠️ | ❌ 不推荐 |

| 每 10 分钟 | 1 | ~30 秒 | 中 ⚠️ | ⚠️ 谨慎使用 |
...
AKSHARE_QUOTES_SYNC_CRON="*/30 9-15 * * 1-5"  # 每 30 分钟
...
AKSHARE_QUOTES_SYNC_ENABLED=true
AKSHARE_QUOTES_SYNC_CRON="*/15 9-15 * *1-5"  # 每 15 分钟（谨慎）
