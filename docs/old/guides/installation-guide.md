...
1. **选择 LLM 提供商**: 在侧边栏选择已配置的 LLM 提供商
2. **选择模型**: 根据需要选择具体的模型
...
# 在 config/settings.json 中配置数据源优先级
...
3.**[A 股分析指南](./a-share-analysis-guide.md)**- A 股市场分析教程
4.**[Docker 部署指南](./docker-deployment-guide.md)**- 生产环境部署
