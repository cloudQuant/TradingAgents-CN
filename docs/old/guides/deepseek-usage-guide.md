...
DeepSeek V3 是 TradingAgents-CN v0.1.7 新集成的成本优化 AI 模型，专为中文金融场景设计。相比 GPT-4，DeepSeek V3 在保持优秀分析质量的同时，成本降低 90%以上，是进行股票分析的理想选择。
...
| **💰 成本**| $0.14/1M tokens | $15/1M tokens | 便宜 90%+ |
...
|**轻度使用**(10 次/天) | ¥5-10 | ¥50-100 | 90%+ |

|**中度使用**(50 次/天) | ¥20-40 | ¥200-400 | 90%+ |

|**重度使用** (100 次/天) | ¥40-80 | ¥400-800 | 90%+ |
...
- 💬 [DeepSeek 社区](<https://github.com/deepseek-ai)>
