...
- [方式二：Docker 版（推荐生产环境）](#方式二 docker 版推荐生产环境)
...
|**🐳 Docker 版**| 生产环境、多用户 | 跨平台、易维护、隔离性好 | 需要学习 Docker | ⭐⭐ 中等 |
...
- **我要部署到服务器，多人使用**→ 选择 [Docker 版](#方式二 docker 版推荐生产环境)
- **我是开发者，想研究代码**→ 选择 [本地代码版](#方式三本地代码版推荐开发者)
- **我用的是 Mac/Linux**→ 选择 [Docker 版](#方式二 docker 版推荐生产环境) 或 [本地代码版](#方式三本地代码版推荐开发者)
