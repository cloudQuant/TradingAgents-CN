...
本检查清单帮助开发者确保新的股票数据 SDK 正确接入到 TradingAgents 系统中。
...
1. **技术文档**: [股票数据 SDK 接入指南](stock_data_sdk_integration_guide.md)
2. **示例代码**:
...
1. **测试脚本**: [集成测试示例](../../tests/test_stock_data_api.py)

- --

- SDK 接入检查清单 - 最后更新: 2025-09-28*
