...
1. stock_financial_data 集合（财务指标：ROE、负债率等）

   ↓

1. 降级机制（使用 stock_basic_info 中的 ROE）
...
📊 [测试 1] 从 stock_basic_info 获取基础信息: 000001
...
📊 [测试 2] 从 stock_financial_data 获取最新财务数据: 000001
...
- *Commit**: `18796fb`
- *Message**: `feat: 优化股票详情基本面数据获取 - 优先从 MongoDB 获取板块、ROE、负债率`
