...
- **Web 导出**: 临时文件，自动下载后清理
- **CLI 导出**: 保存到 `./exports/` 目录
- **Docker 环境**: 映射到主机目录（如配置）
...
感谢他的杰出贡献，让 TradingAgents-CN 拥有了专业级的报告导出能力！
